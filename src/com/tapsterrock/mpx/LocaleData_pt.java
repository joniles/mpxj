...
public final class LocaleData_pt extends ListResourceBundle
{
	...
	public Object[][] getContents()
   {
	...
	private static final String[] TIME_UNITS_ARRAY_DATA = {"m", "h", "d", "s", "mes", "a", "%", "em", "eh", "ed", "es", "emes", "ea", "e%"};
	...
	static 
   {
	...
	private static final Object[][] RESOURCE_DATA = {
		...
		{LocaleData.DATE_ORDER, new Integer(1)},
		{LocaleData.TIME_FORMAT, new Integer(0)},
		{LocaleData.DEFAULT_START_TIME, new Integer(480)},
		{LocaleData.DATE_SEPARATOR, "/"},
		{LocaleData.TIME_SEPARATOR, ":"},
		{LocaleData.AM_TEXT, ""},
		{LocaleData.PM_TEXT, ""},
		{LocaleData.DATE_FORMAT, new Integer (20)},
