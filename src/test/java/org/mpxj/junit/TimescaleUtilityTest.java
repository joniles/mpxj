...
public class TimescaleUtilityTest
{
   ...
   @Test public void testMinutes()
   {
      ...
      List<LocalDateTimeRange> result = ts.createTimescale(startDate, TimescaleUnits.MINUTES, 5);
      assertEquals("22/06/2023 00:00:00.0 22/06/2023 00:01:00.0", result.get(0));
      assertEquals("22/06/2023 00:01:00.0 22/06/2023 00:02:00.0", result.get(1));
      assertEquals("22/06/2023 00:02:00.0 22/06/2023 00:03:00.0", result.get(2));
      assertEquals("22/06/2023 00:03:00.0 22/06/2023 00:04:00.0", result.get(3));
      assertEquals("22/06/2023 00:04:00.0 22/06/2023 00:05:00.0", result.get(4));
   }
   ...
   @Test public void testHours()
   {
      ...
      List<LocalDateTimeRange> result = ts.createTimescale(startDate, TimescaleUnits.HOURS, 5);
      assertEquals("22/06/2023 00:00:00.0 22/06/2023 01:00:00.0", result.get(0));
      assertEquals("22/06/2023 01:00:00.0 22/06/2023 02:00:00.0", result.get(1));
      assertEquals("22/06/2023 02:00:00.0 22/06/2023 03:00:00.0", result.get(2));
      assertEquals("22/06/2023 03:00:00.0 22/06/2023 04:00:00.0", result.get(3));
      assertEquals("22/06/2023 04:00:00.0 22/06/2023 05:00:00.0", result.get(4));
   }
   ...
   @Test public void testDays()
   {
      ...
      List<LocalDateTimeRange> result = ts.createTimescale(startDate, TimescaleUnits.DAYS, 5);
   ...
   @Test public void testWeeks()
   {
      ...
      List<LocalDateTimeRange> result = ts.createTimescale(startDate, TimescaleUnits.WEEKS, 5);
   ...
   @Test public void testThirdsOfMonths()
   {
      ...
      List<LocalDateTimeRange> result = ts.createTimescale(startDate, TimescaleUnits.THIRDS_OF_MONTHS, 5);
   ...
   @Test public void testMonths()
   {
      ...
      List<LocalDateTimeRange> result = ts.createTimescale(startDate, TimescaleUnits.MONTHS, 5);
   ...
   @Test public void testQuarters()
   {
      ...
      List<LocalDateTimeRange> result = ts.createTimescale(startDate, TimescaleUnits.QUARTERS, 5);
   ...
   @Test public void testHalfYears()
   {
      ...
      List<LocalDateTimeRange> result = ts.createTimescale(startDate, TimescaleUnits.HALF_YEARS, 5);
   ...
   @Test public void testYears()
   {
      ...
      List<LocalDateTimeRange> result = ts.createTimescale(startDate, TimescaleUnits.YEARS, 5);
