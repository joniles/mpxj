...
@SuppressWarnings("boxing") public class TimephasedBudgetTest
{
   ...
   @Test public void testBudgetBaselines() throws Exception
   {
      ...
      TimephasedTestHelper.testNumericSegments(task.getTimephasedBaselineBudgetCost(0, ranges), new Double[]{26.00, 26.00, null, null, 26.00, 24.00, null, 24.00, 24.00, 5.00, null, 16.00, 24.00, 24.00, 24.00, 24.00, null, null, 24.00, 24.00, 24.00, 24.00, 24.00, null, null, 24.00, 24.00, 24.00, 24.00, 24.00});
      TimephasedTestHelper.testDurationSegments(task.getTimephasedBaselineBudgetWork(0, ranges, TimeUnit.HOURS), new Double[]{27.2, 27.2, null, null, 27.2, 25.2, null, 25.2, 16.8, null, 5.0, 25.2, 16.8, 8.4, 25.2, 25.2, null, null, 25.2, 25.2, 25.2, 25.2, 25.2, null, null, 25.2, 25.2, 25.2, 25.2, 16.8});

      ResourceAssignment assignment = task.getResourceAssignments().get(0);
      assertEquals("Concrete Labor", assignment.getResource().getName());
      TimephasedTestHelper.testDurationSegments(assignment.getTimephasedBaselineBudgetWork(0, ranges, TimeUnit.HOURS), new Double[]{10.4, 10.4, null, null, 10.4, 8.4, null, 8.4, 0.0, null, 5.0, 8.4, 0.0, 8.4, 8.4, 8.4, null, null, 8.4, 8.4, 8.4, 8.4, 8.4, null, null, 8.4, 8.4, 8.4, 8.4, null});

      assignment = task.getResourceAssignments().get(1);
      assertEquals("Steel Labor", assignment.getResource().getName());
      TimephasedTestHelper.testDurationSegments(assignment.getTimephasedBaselineBudgetWork(0, ranges, TimeUnit.HOURS), new Double[]{16.8, 16.8, null, null, 16.8, 16.8, null, 16.8, 16.8, null, null, 16.8, 16.8, 0.0, 16.8, 16.8, null, null, 16.8, 16.8, 16.8, 16.8, 16.8, null, null, 16.8, 16.8, 16.8, 16.8, 16.8});

      assignment = task.getResourceAssignments().get(2);
      assertEquals("Concrete Cost", assignment.getResource().getName());
      TimephasedTestHelper.testNumericSegments(assignment.getTimephasedBaselineBudgetCost(0, ranges), new Double[]{10.00, 10.00, null, null, 10.00, 8.00, null, 8.00, 8.00, 5.00, null, 0.00, 8.00, 8.00, 8.00, 8.00, null, null, 8.00, 8.00, 8.00, 8.00, 8.00, null, null, 8.00, 8.00, 8.00, 8.00, 8.00});

      assignment = task.getResourceAssignments().get(3);
      assertEquals("Steel Cost", assignment.getResource().getName());
      TimephasedTestHelper.testNumericSegments(assignment.getTimephasedBaselineBudgetCost(0, ranges), new Double[]{16.00, 16.00, null, null, 16.00, 16.00, null, 16.00, 16.00, null, null, 16.00, 16.00, 16.00, 16.00, 16.00, null, null, 16.00, 16.00, 16.00, 16.00, 16.00, null, null, 16.00, 16.00, 16.00, 16.00, 16.00});
   }
}
