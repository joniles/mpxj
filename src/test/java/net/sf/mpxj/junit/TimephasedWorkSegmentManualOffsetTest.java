...
public class TimephasedWorkSegmentManualOffsetTest
{
   ...
   private void testSegments(ResourceAssignment assignment, LocalDateTime startDate, int segmentCount, TimescaleUnits units, boolean complete)
   {
      ...
      ArrayList<Duration> durationList = m_timephased.segmentWork(calendar, assignments, units, dateList, assignment.getTask().getTaskMode() == TaskMode.MANUALLY_SCHEDULED);
