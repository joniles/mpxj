...
public class CombinedCalendarTest
{
   ...
   @Test public void testCombinedCalendar() throws Exception
   {
      ...
      hours.clear();
      hours.add(new DateRange(DateHelper.getTime(9, 0), DateHelper.getTime(13, 0)));
      ...
      hours.clear();
      hours.add(new DateRange(DateHelper.getTime(0, 0), DateHelper.getTime(8, 0)));
      ...
      exception.add(new DateRange(DateHelper.getTime(9, 0), DateHelper.getTime(13, 0)));
