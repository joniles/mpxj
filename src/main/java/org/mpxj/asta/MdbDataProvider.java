...
class MdbDataProvider implements AstaDataProvider
{
   ...
   @Override public List<Row> getRows(String tableName, Map<String, Integer> keys, Map<String, String> nameMap) throws AstaDatabaseException
   {
      try
      {
         if (m_database == null)
   ...
   @Override public void allocateResources(File file)
   {
      m_databaseFile = file;
   }
