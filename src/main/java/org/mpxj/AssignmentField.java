...
public enum AssignmentField implements FieldType
{
   ...
   TIMEPHASED_REMAINING_WORK(DataType.BINARY),
   TIMEPHASED_REMAINING_COST(DataType.BINARY),
   TIMEPHASED_OVERTIME_WORK(DataType.BINARY),
   TIMEPHASED_PLANNED_WORK(DataType.BINARY),
   TIMEPHASED_ACTUAL_WORK(DataType.BINARY),
   TIMEPHASED_ACTUAL_COST(DataType.BINARY),
   TIMEPHASED_ACTUAL_IRREGULAR_WORK(DataType.BINARY),
