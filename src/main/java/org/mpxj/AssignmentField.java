...
public enum AssignmentField implements FieldType
{
   ...
   RAW_TIMEPHASED_REMAINING_REGULAR_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_REMAINING_OVERTIME_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_PLANNED_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_ACTUAL_REGULAR_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_ACTUAL_IRREGULAR_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_ACTUAL_OVERTIME_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE1_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE2_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE3_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE4_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE5_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE6_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE7_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE8_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE9_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE10_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE1_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE2_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE3_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE4_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE5_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE6_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE7_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE8_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE9_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE10_COST(DataType.TIMEPHASED_COST_LIST),
   ...
   PLANNED_MATERIAL(DataType.NUMERIC),
   ACTUAL_MATERIAL(DataType.NUMERIC),
   REMAINING_MATERIAL(DataType.NUMERIC),
   MATERIAL(DataType.NUMERIC),
   BASELINE_MATERIAL(DataType.NUMERIC),
   BASELINE1_MATERIAL(DataType.NUMERIC),
   BASELINE2_MATERIAL(DataType.NUMERIC),
   BASELINE3_MATERIAL(DataType.NUMERIC),
   BASELINE4_MATERIAL(DataType.NUMERIC),
   BASELINE5_MATERIAL(DataType.NUMERIC),
   BASELINE6_MATERIAL(DataType.NUMERIC),
   ...
   RAW_TIMEPHASED_BUDGET_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BUDGET_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE_BUDGET_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE_BUDGET_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE1_BUDGET_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE1_BUDGET_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE2_BUDGET_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE2_BUDGET_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE3_BUDGET_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE3_BUDGET_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE4_BUDGET_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE4_BUDGET_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE5_BUDGET_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE5_BUDGET_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE6_BUDGET_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE6_BUDGET_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE7_BUDGET_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE7_BUDGET_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE8_BUDGET_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE8_BUDGET_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE9_BUDGET_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE9_BUDGET_COST(DataType.TIMEPHASED_COST_LIST),
   RAW_TIMEPHASED_BASELINE10_BUDGET_WORK(DataType.TIMEPHASED_WORK_LIST),
   RAW_TIMEPHASED_BASELINE10_BUDGET_COST(DataType.TIMEPHASED_COST_LIST),
   FINISH(DataType.DATE),
   ASSIGNMENT_REMAINING_DELAY(DataType.DURATION);
