...
public enum AssignmentField implements FieldType
{
   ...
   TIMEPHASED_REMAINING_REGULAR_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_REMAINING_OVERTIME_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_PLANNED_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_ACTUAL_REGULAR_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_ACTUAL_IRREGULAR_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_ACTUAL_OVERTIME_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_BASELINE_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_BASELINE1_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_BASELINE2_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_BASELINE3_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_BASELINE4_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_BASELINE5_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_BASELINE6_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_BASELINE7_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_BASELINE8_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_BASELINE9_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_BASELINE10_WORK(DataType.TIMEPHASED_WORK_LIST),
   TIMEPHASED_BASELINE_COST(DataType.TIMEPHASED_COST_LIST),
   TIMEPHASED_BASELINE1_COST(DataType.TIMEPHASED_COST_LIST),
   TIMEPHASED_BASELINE2_COST(DataType.TIMEPHASED_COST_LIST),
   TIMEPHASED_BASELINE3_COST(DataType.TIMEPHASED_COST_LIST),
   TIMEPHASED_BASELINE4_COST(DataType.TIMEPHASED_COST_LIST),
   TIMEPHASED_BASELINE5_COST(DataType.TIMEPHASED_COST_LIST),
   TIMEPHASED_BASELINE6_COST(DataType.TIMEPHASED_COST_LIST),
   TIMEPHASED_BASELINE7_COST(DataType.TIMEPHASED_COST_LIST),
   TIMEPHASED_BASELINE8_COST(DataType.TIMEPHASED_COST_LIST),
   TIMEPHASED_BASELINE9_COST(DataType.TIMEPHASED_COST_LIST),
   TIMEPHASED_BASELINE10_COST(DataType.TIMEPHASED_COST_LIST),
