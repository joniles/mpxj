...
public enum ProjectField implements FieldType
{
   ...
   LAST_SCHEDULED_DATE(DataType.DATE),
   ACTIVITY_PERCENT_COMPLETE_BASED_ON_ACTIVITY_STEPS(DataType.BOOLEAN),
   ACTIVITY_DEFAULT_PRICE_PER_UNIT(DataType.CURRENCY),
   UPDATE_UNITS_WHEN_COSTS_CHANGE_ON_RESOURCE_ASSIGNMENTS(DataType.BOOLEAN);
