...
class FieldMap12 extends FieldMap
{
   ...
   @Override protected FieldItem[] getDefaultAssignmentData()
   {
      return new FieldItem[]
      {
         ...
         new FieldItem(AssignmentField.TIMEPHASED_REMAINING_REGULAR_WORK, FieldLocation.VAR_DATA, 0, 65535, 49, 0, 0),
         new FieldItem(AssignmentField.TIMEPHASED_ACTUAL_REGULAR_WORK, FieldLocation.VAR_DATA, 0, 65535, 50, 0, 0),
