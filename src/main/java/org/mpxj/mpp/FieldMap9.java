...
class FieldMap9 extends FieldMap
{
   ...
   @Override protected FieldItem[] getDefaultAssignmentData()
   {
      return new FieldItem[]
      {
         ...
         new FieldItem(AssignmentField.RAW_TIMEPHASED_REMAINING_REGULAR_WORK, FieldLocation.VAR_DATA, 0, 65535, 7, 0, 0),
         new FieldItem(AssignmentField.RAW_TIMEPHASED_ACTUAL_REGULAR_WORK, FieldLocation.VAR_DATA, 0, 65535, 9, 0, 0),
