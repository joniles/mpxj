...
public enum TaskField implements FieldType
{
   ...
   ACTUAL_WORK_NONLABOR(DataType.DURATION), // TODO: deprecated, rename to ACTUAL_WORK_NON_LABOR
   PLANNED_WORK_LABOR(DataType.DURATION),
   PLANNED_WORK_NONLABOR(DataType.DURATION), // TODO: deprecated, rename to PLANNED_WORK_NON_LABOR
   REMAINING_WORK_LABOR(DataType.DURATION),
   REMAINING_WORK_NONLABOR(DataType.DURATION), // TODO: deprecated, rename to REMAINING_WORK_NON_LABOR
   ...
   PLANNED_COST_LABOR(DataType.CURRENCY),
   PLANNED_COST_NON_LABOR(DataType.CURRENCY),
   PLANNED_COST_MATERIAL(DataType.CURRENCY),
   PLANNED_COST_EXPENSE(DataType.CURRENCY),
   ACTUAL_COST_LABOR(DataType.CURRENCY),
   ACTUAL_COST_NON_LABOR(DataType.CURRENCY),
   ACTUAL_COST_MATERIAL(DataType.CURRENCY),
   ACTUAL_COST_EXPENSE(DataType.CURRENCY),
   REMAINING_COST_LABOR(DataType.CURRENCY),
   REMAINING_COST_NON_LABOR(DataType.CURRENCY),
   REMAINING_COST_MATERIAL(DataType.CURRENCY),
   REMAINING_COST_EXPENSE(DataType.CURRENCY);
