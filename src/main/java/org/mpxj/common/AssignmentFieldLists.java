...
public final class AssignmentFieldLists
{
   ...
   public static final AssignmentField[] RAW_TIMEPHASED_BASELINE_BUDGET_WORKS = {
      AssignmentField.RAW_TIMEPHASED_BASELINE_BUDGET_WORK,
      AssignmentField.RAW_TIMEPHASED_BASELINE1_BUDGET_WORK,
      AssignmentField.RAW_TIMEPHASED_BASELINE2_BUDGET_WORK,
      AssignmentField.RAW_TIMEPHASED_BASELINE3_BUDGET_WORK,
      AssignmentField.RAW_TIMEPHASED_BASELINE4_BUDGET_WORK,
      AssignmentField.RAW_TIMEPHASED_BASELINE5_BUDGET_WORK,
      AssignmentField.RAW_TIMEPHASED_BASELINE6_BUDGET_WORK,
      AssignmentField.RAW_TIMEPHASED_BASELINE7_BUDGET_WORK,
      AssignmentField.RAW_TIMEPHASED_BASELINE8_BUDGET_WORK,
      AssignmentField.RAW_TIMEPHASED_BASELINE9_BUDGET_WORK,
      AssignmentField.RAW_TIMEPHASED_BASELINE10_BUDGET_WORK
   };

   public static final AssignmentField[] RAW_TIMEPHASED_BASELINE_BUDGET_COSTS = {
      AssignmentField.RAW_TIMEPHASED_BASELINE_BUDGET_COST,
      AssignmentField.RAW_TIMEPHASED_BASELINE1_BUDGET_COST,
      AssignmentField.RAW_TIMEPHASED_BASELINE2_BUDGET_COST,
      AssignmentField.RAW_TIMEPHASED_BASELINE3_BUDGET_COST,
      AssignmentField.RAW_TIMEPHASED_BASELINE4_BUDGET_COST,
      AssignmentField.RAW_TIMEPHASED_BASELINE5_BUDGET_COST,
      AssignmentField.RAW_TIMEPHASED_BASELINE6_BUDGET_COST,
      AssignmentField.RAW_TIMEPHASED_BASELINE7_BUDGET_COST,
      AssignmentField.RAW_TIMEPHASED_BASELINE8_BUDGET_COST,
      AssignmentField.RAW_TIMEPHASED_BASELINE9_BUDGET_COST,
      AssignmentField.RAW_TIMEPHASED_BASELINE10_BUDGET_COST
   };
}
