...
public class ProjectCalendar extends ProjectCalendarDays implements ProjectEntityWithMutableUniqueID, TimeUnitDefaultsContainer
{
    ...
    * project-specific calendars relevant to the support project.
    *
   ...
   /**
    * If this calendar is owned by a specific project, this method will return the Unique ID of that project.
    *
    * @return project unique ID or null if this is not a project-specific calendar
    */
   ...
   /**
    * Sets the unique ID of the project which owns this calendar, or null if this calendar is not
    * project-specific.
    *
    * @param projectUniqueID project unique ID or null
    */
