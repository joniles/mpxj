...
final class ActivityTypeHelper
{
   ...
   static
   {
      XML_TYPE_MAP.put("Task Dependent", net.sf.mpxj.ActivityType.TASK_DEPENDENT);
      XML_TYPE_MAP.put("Resource Dependent", net.sf.mpxj.ActivityType.RESOURCE_DEPENDENT);
      XML_TYPE_MAP.put("Level of Effort", net.sf.mpxj.ActivityType.LEVEL_OF_EFFORT);
   ...
   static
   {
      TYPE_XML_MAP.put(net.sf.mpxj.ActivityType.TASK_DEPENDENT, "Task Dependent");
      TYPE_XML_MAP.put(net.sf.mpxj.ActivityType.RESOURCE_DEPENDENT, "Resource Dependent");
      TYPE_XML_MAP.put(net.sf.mpxj.ActivityType.LEVEL_OF_EFFORT, "Level of Effort");
      TYPE_XML_MAP.put(net.sf.mpxj.ActivityType.START_MILESTONE, "Start Milestone");
      TYPE_XML_MAP.put(net.sf.mpxj.ActivityType.FINISH_MILESTONE, "Finish Milestone");
      TYPE_XML_MAP.put(net.sf.mpxj.ActivityType.WBS_SUMMARY, "WBS Summary");
      TYPE_XML_MAP.put(net.sf.mpxj.ActivityType.START_FLAG, "Start Milestone");
      TYPE_XML_MAP.put(net.sf.mpxj.ActivityType.FINISH_FLAG, "Finish Milestone");
      TYPE_XML_MAP.put(net.sf.mpxj.ActivityType.HAMMOCK, "Resource Dependent");
   }
