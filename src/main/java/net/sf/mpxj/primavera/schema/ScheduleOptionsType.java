...
}) public class ScheduleOptionsType
{
   ...
   @XmlElement(name = "IncludeExternalResAss", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean includeExternalResAss;
   ...
   @XmlElement(name = "OverAllocationPercentage", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "double") protected Double overAllocationPercentage;
   @XmlElement(name = "PreserveScheduledEarlyAndLateDates", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean preserveScheduledEarlyAndLateDates;
