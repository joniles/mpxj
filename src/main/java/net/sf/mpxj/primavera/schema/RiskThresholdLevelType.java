...
}) public class RiskThresholdLevelType
{
   ...
   @XmlElement(name = "CostRange", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "double") protected Double costRange;
   ...
   @XmlElement(name = "ProbabilityRange", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double probabilityRange;
   ...
   @XmlElement(name = "ScheduleRange", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "double") protected Double scheduleRange;
