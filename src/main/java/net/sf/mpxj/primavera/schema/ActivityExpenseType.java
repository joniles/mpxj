...
}) public class ActivityExpenseType
{
   ...
   @XmlElement(name = "ExpensePercentComplete", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "double") protected Double expensePercentComplete;
   ...
   @XmlElement(name = "OverBudget", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean overBudget;
   ...
   @XmlElement(name = "PricePerUnit", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "double") protected Double pricePerUnit;
