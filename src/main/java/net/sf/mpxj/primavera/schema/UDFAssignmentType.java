...
}) public class UDFAssignmentType
{
   ...
   @XmlElement(name = "CostValue", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "double") protected Double costValue;
   ...
   @XmlElement(name = "DoubleValue", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "double") protected Double doubleValue;
   @XmlElement(name = "TextValue") protected String textValue;
   @XmlElement(name = "StartDateValue", type = String.class) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date startDateValue;
   @XmlElement(name = "FinishDateValue", type = String.class) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date finishDateValue;
