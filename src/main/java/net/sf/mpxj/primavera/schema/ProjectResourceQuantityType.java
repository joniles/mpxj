...
}) public class ProjectResourceQuantityType
{
   ...
   @XmlElement(name = "FinancialPeriod1Quantity", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double financialPeriod1Quantity;
   @XmlElement(name = "FinancialPeriod2ObjectId", nillable = true) protected Integer financialPeriod2ObjectId;
   @XmlElement(name = "FinancialPeriod2Quantity", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double financialPeriod2Quantity;
   ...
   @XmlElement(name = "MonthStartDate", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "dateTime") protected Date monthStartDate;
   ...
   @XmlElement(name = "Quantity", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) protected Double quantity;
   ...
   @XmlElement(name = "WeekStartDate", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "dateTime") protected Date weekStartDate;
