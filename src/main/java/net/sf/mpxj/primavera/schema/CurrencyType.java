...
}) public class CurrencyType
{
   ...
   @XmlElement(name = "ExchangeRate", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) protected Double exchangeRate;
   @XmlElement(name = "Id") protected String id;
   @XmlElement(name = "IsBaseCurrency", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean isBaseCurrency;
