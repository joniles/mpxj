...
}) public class LeanTaskType
{
   ...
   @XmlElement(name = "CompletedDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "dateTime") protected Date completedDate;
   ...
   @XmlElement(name = "DueDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "dateTime") protected Date dueDate;
   @XmlElement(name = "Duration", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double duration;
   ...
   @XmlElement(name = "ProposedDueDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "dateTime") protected Date proposedDueDate;
