...
}) public class LeanTaskType
{
   ...
   @XmlElement(name = "CompletedDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date completedDate;
   ...
   @XmlElement(name = "DueDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date dueDate;
   ...
   @XmlElement(name = "ProposedDueDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date proposedDueDate;
