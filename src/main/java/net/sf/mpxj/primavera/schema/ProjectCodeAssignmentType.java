...
public class ProjectCodeAssignmentType {
    ...
    @XmlJavaTypeAdapter(Adapter1 .class)
    protected String projectCodeDescription;
    @XmlElement(name = "ProjectCodeObjectId")
    protected Integer projectCodeObjectId;
    @XmlElement(name = "ProjectCodeTypeName")
    @XmlJavaTypeAdapter(Adapter1 .class)
    protected String projectCodeTypeName;
    @XmlElement(name = "ProjectCodeTypeObjectId", nillable = true)
    protected Integer projectCodeTypeObjectId;
    @XmlElement(name = "ProjectCodeValue")
    @XmlJavaTypeAdapter(Adapter1 .class)
    protected String projectCodeValue;
