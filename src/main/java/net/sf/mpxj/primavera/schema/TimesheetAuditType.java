...
}) public class TimesheetAuditType
{
   ...
   @XmlElement(name = "AuditDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date auditDate;
   ...
   @XmlElement(name = "TimesheetPeriodEndDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date timesheetPeriodEndDate;
   @XmlElement(name = "TimesheetPeriodObjectId", nillable = true) protected Integer timesheetPeriodObjectId;
   @XmlElement(name = "TimesheetPeriodStartDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date timesheetPeriodStartDate;
