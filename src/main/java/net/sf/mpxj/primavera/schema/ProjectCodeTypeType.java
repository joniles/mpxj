...
}) public class ProjectCodeTypeType
{
   ...
   @XmlElement(name = "MaxCodeValueWeight", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double maxCodeValueWeight;
   @XmlElement(name = "Name") protected String name;
   @XmlElement(name = "ObjectId") protected Integer objectId;
   @XmlElement(name = "SequenceNumber") protected Integer sequenceNumber;
   @XmlElement(name = "Weight", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double weight;
