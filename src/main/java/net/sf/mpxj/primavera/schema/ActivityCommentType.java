...
}) public class ActivityCommentType
{
   ...
   @XmlElement(name = "CommentDate", type = String.class) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date commentDate;
   ...
   @XmlElement(name = "DeleteDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date deleteDate;
