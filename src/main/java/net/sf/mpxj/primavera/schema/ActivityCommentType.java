...
}) public class ActivityCommentType
{
   ...
   @XmlElement(name = "CommentDate", type = String.class) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date commentDate;
   ...
   @XmlElement(name = "DeleteDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date deleteDate;
   @XmlElement(name = "DeleteUser") protected String deleteUser;
   @XmlElement(name = "IsRejected", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean isRejected;
   ...
   @XmlElement(name = "ReadFlag", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean readFlag;
