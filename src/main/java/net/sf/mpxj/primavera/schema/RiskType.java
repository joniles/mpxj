...
}) public class RiskType
{
   ...
   @XmlElement(name = "Exposure", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "double") protected Double exposure;
   @XmlElement(name = "ExposureFinishDate", type = String.class) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date exposureFinishDate;
   @XmlElement(name = "ExposureStartDate", type = String.class) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date exposureStartDate;
   ...
   @XmlElement(name = "IdentifiedDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date identifiedDate;
   ...
   @XmlElement(name = "ResponseTotalCost", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "double") protected Double responseTotalCost;
