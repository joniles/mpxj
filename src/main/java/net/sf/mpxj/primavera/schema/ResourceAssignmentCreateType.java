...
}) public class ResourceAssignmentCreateType
{
   ...
   @XmlElement(name = "ActualUnits", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double actualUnits;
   ...
   @XmlElement(name = "RemainingUnits", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double remainingUnits;
