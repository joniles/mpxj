...
}) public class ProjectIssueType
{
   ...
   @XmlElement(name = "ActualValue", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "double") protected Double actualValue;
   ...
   @XmlElement(name = "DateIdentified", type = String.class) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date dateIdentified;
   ...
   @XmlElement(name = "LowerThreshold", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double lowerThreshold;
   ...
   @XmlElement(name = "ResolutionDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date resolutionDate;
   ...
   @XmlElement(name = "UpperThreshold", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double upperThreshold;
