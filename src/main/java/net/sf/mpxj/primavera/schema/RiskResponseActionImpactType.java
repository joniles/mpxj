...
public class RiskResponseActionImpactType {
    ...
    @XmlJavaTypeAdapter(Adapter1 .class)
    protected String riskResponseActionId;
    @XmlElement(name = "RiskResponseActionName")
    @XmlJavaTypeAdapter(Adapter1 .class)
    protected String riskResponseActionName;
    @XmlElement(name = "RiskResponseActionObjectId")
    protected Integer riskResponseActionObjectId;
    @XmlElement(name = "RiskThresholdLevelCode")
    @XmlJavaTypeAdapter(Adapter1 .class)
    protected String riskThresholdLevelCode;
    @XmlElement(name = "RiskThresholdLevelName")
    @XmlJavaTypeAdapter(Adapter1 .class)
    protected String riskThresholdLevelName;
    @XmlElement(name = "RiskThresholdLevelObjectId")
    protected Integer riskThresholdLevelObjectId;
