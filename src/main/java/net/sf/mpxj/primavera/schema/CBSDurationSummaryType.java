...
}) public class CBSDurationSummaryType
{
   ...
   @XmlElement(name = "SummaryPercentComplete", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "double") protected Double summaryPercentComplete;
