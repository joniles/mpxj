...
}) public class CBSDurationSummaryType
{
   ...
   @XmlElement(name = "SummaryPercentComplete", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "double") protected Double summaryPercentComplete;
