...
public class ResourceRequestType {
    ...
    @XmlElement(name = "MatchAllCriteria", type = String.class)
    ...
    @XmlElement(name = "RequestedUnits", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "double")
    protected Double requestedUnits;
    @XmlElement(name = "SequenceNumber")
    protected Integer sequenceNumber;
    @XmlElement(name = "ShowOnlyLaborResources", type = String.class)
    @XmlJavaTypeAdapter(Adapter2 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean showOnlyLaborResources;
    @XmlElement(name = "ShowOverallocatedResources", type = String.class)
    @XmlJavaTypeAdapter(Adapter2 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean showOverallocatedResources;
    @XmlElement(name = "SortResultsByAvailability", type = String.class)
    @XmlJavaTypeAdapter(Adapter2 .class)
    @XmlSchemaType(name = "boolean")
    ...
    @XmlElement(name = "UseActivityDates", type = String.class)
    @XmlJavaTypeAdapter(Adapter2 .class)
    @XmlSchemaType(name = "boolean")
