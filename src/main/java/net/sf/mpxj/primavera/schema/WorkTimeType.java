...
}) public class WorkTimeType
{
   ...
   @XmlElement(name = "Start", type = String.class) @XmlJavaTypeAdapter(Adapter3.class) protected Date start;
   @XmlElement(name = "Finish", type = String.class) @XmlJavaTypeAdapter(Adapter3.class) protected Date finish;
