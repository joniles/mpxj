...
}) public class UDFValueType
{
   ...
   @XmlElement(name = "Cost", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "double") protected Double cost;
   ...
   @XmlElement(name = "Double", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double _double;
