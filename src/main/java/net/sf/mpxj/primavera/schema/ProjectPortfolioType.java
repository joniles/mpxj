...
}) public class ProjectPortfolioType
{
   ...
   @XmlElement(name = "IncludeClosedProjects", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean includeClosedProjects;
   @XmlElement(name = "IncludeWhatIfProjects", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean includeWhatIfProjects;
