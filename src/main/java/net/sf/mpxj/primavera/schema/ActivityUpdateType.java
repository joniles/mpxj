...
public class ActivityUpdateType {
    ...
    @XmlElement(name = "OverrideConstraintDate", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "dateTime")
    protected Date overrideConstraintDate;
    @XmlElement(name = "OverrideConstraintType")
    @XmlJavaTypeAdapter(Adapter1 .class)
    ...
    @XmlElement(name = "OverrideResumeDate", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "dateTime")
    protected Date overrideResumeDate;
    @XmlElement(name = "OverrideSuspendDate", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "dateTime")
    protected Date overrideSuspendDate;
    ...
    @XmlElement(name = "PendingConstraintDate", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "dateTime")
    protected Date pendingConstraintDate;
    @XmlElement(name = "PendingConstraintType")
    @XmlJavaTypeAdapter(Adapter1 .class)
    ...
    @XmlElement(name = "PendingResumeDate", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "dateTime")
    protected Date pendingResumeDate;
    @XmlElement(name = "PendingSuspendDate", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter4 .class)
    @XmlSchemaType(name = "dateTime")
    protected Date pendingSuspendDate;
