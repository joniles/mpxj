...
}) public class ActivityPeriodActualType
{
   ...
   @XmlElement(name = "ActualLaborCost", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "double") protected Double actualLaborCost;
   @XmlElement(name = "ActualLaborUnits", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "double") protected Double actualLaborUnits;
   ...
   @XmlElement(name = "ActualNonLaborCost", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "double") protected Double actualNonLaborCost;
   @XmlElement(name = "ActualNonLaborUnits", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "double") protected Double actualNonLaborUnits;
