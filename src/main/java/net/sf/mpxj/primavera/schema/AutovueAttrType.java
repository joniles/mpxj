...
}) public class AutovueAttrType
{
   ...
   @XmlElement(name = "AVPropertyLastUpdated", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date avPropertyLastUpdated;
    ...
    *     
    */
   public void setAVPropertyLastUpdated(Date value)
   {
