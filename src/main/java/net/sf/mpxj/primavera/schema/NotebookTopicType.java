...
}) public class NotebookTopicType
{
   ...
   @XmlElement(name = "AvailableForActivity", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean availableForActivity;
   @XmlElement(name = "AvailableForEPS", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean availableForEPS;
   @XmlElement(name = "AvailableForProject", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean availableForProject;
   @XmlElement(name = "AvailableForWBS", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean availableForWBS;
