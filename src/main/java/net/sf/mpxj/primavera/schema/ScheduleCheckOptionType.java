...
}) public class ScheduleCheckOptionType
{
   ...
   @XmlElement(name = "BEITripwireTarget", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double beiTripwireTarget;
   @XmlElement(name = "CheckBEITripwire", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkBEITripwire;
   @XmlElement(name = "CheckHardConstraints", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkHardConstraints;
   @XmlElement(name = "CheckInvalidProgress", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkInvalidProgress;
   @XmlElement(name = "CheckLags", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkLags;
   @XmlElement(name = "CheckLargeDurations", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkLargeDurations;
   @XmlElement(name = "CheckLargeFloat", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkLargeFloat;
   @XmlElement(name = "CheckLateActivities", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkLateActivities;
   @XmlElement(name = "CheckLogic", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkLogic;
   @XmlElement(name = "CheckLongLags", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkLongLags;
   @XmlElement(name = "CheckNegativeFloat", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkNegativeFloat;
   @XmlElement(name = "CheckNegativeLags", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkNegativeLags;
   @XmlElement(name = "CheckRelationShips", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkRelationShips;
   @XmlElement(name = "CheckResources", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkResources;
   @XmlElement(name = "CheckSoftConstraints", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkSoftConstraints;
