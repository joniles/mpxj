...
public class UserInterfaceViewType {
    ...
    @XmlElement(name = "StatusUpdatesApproval", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter2 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean statusUpdatesApproval;
    @XmlElement(name = "TimesheetApproval", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter2 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean timesheetApproval;
