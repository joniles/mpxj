...
}) public class ProjectNoteType
{
   ...
   @XmlElement(name = "AvailableForActivity", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean availableForActivity;
   @XmlElement(name = "AvailableForEPS", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean availableForEPS;
   @XmlElement(name = "AvailableForProject", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean availableForProject;
   @XmlElement(name = "AvailableForWBS", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean availableForWBS;
