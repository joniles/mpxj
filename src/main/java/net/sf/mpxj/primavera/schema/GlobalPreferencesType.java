...
}) public class GlobalPreferencesType
{
   ...
   @XmlElement(name = "DefaultDuration", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) protected Double defaultDuration;
   ...
   @XmlElement(name = "EVEstimateToCompleteFactor", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double evEstimateToCompleteFactor;
   @XmlElement(name = "EVEstimateToCompleteTechnique") protected String evEstimateToCompleteTechnique;
   @XmlElement(name = "EVPerformancePctCompleteCustomPct", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "double") protected Double evPerformancePctCompleteCustomPct;
   ...
   @XmlElement(name = "EmailNotifyTSRejection", nillable = true) protected Boolean emailNotifyTSRejection;
   ...
   @XmlElement(name = "EnableWebServicesIPCheck", nillable = true) protected Boolean enableWebServicesIPCheck;
   ...
   @XmlElement(name = "HoursPerDay", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) protected Double hoursPerDay;
   @XmlElement(name = "HoursPerMonth", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) protected Double hoursPerMonth;
   @XmlElement(name = "HoursPerWeek", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) protected Double hoursPerWeek;
   @XmlElement(name = "HoursPerYear", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) protected Double hoursPerYear;
   ...
   @XmlElement(name = "MaxTimesheetResourceHours", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double maxTimesheetResourceHours;
   ...
   @XmlElement(name = "ReportEnableLazyLoad", nillable = true) protected Boolean reportEnableLazyLoad;
   @XmlElement(name = "ResourcesCanAssignThemselvesToActivities") protected Boolean resourcesCanAssignThemselvesToActivities;
   @XmlElement(name = "ResourcesCanAssignThemselvesToActivitiesOutsideTheirOBSAccess") protected Boolean resourcesCanAssignThemselvesToActivitiesOutsideTheirOBSAccess;
