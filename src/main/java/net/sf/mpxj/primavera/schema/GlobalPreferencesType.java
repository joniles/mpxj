...
}) public class GlobalPreferencesType
{
   ...
   @XmlElement(name = "AlwaysLaunchOnlineHelp", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean alwaysLaunchOnlineHelp;
   ...
   @XmlElement(name = "DefaultDuration", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) protected Double defaultDuration;
   @XmlElement(name = "DefaultTimesheetApprovalManager", nillable = true) protected Integer defaultTimesheetApprovalManager;
   @XmlElement(name = "EPPMConsentMessage") protected String eppmConsentMessage;
   @XmlElement(name = "EPPMEnableConsent") protected String eppmEnableConsent;
   @XmlElement(name = "EVEstimateToCompleteFactor", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double evEstimateToCompleteFactor;
   @XmlElement(name = "EVEstimateToCompleteTechnique") protected String evEstimateToCompleteTechnique;
   @XmlElement(name = "EVPerformancePctCompleteCustomPct", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "double") protected Double evPerformancePctCompleteCustomPct;
   ...
   @XmlElement(name = "EmailNotifyTSRejection", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean emailNotifyTSRejection;
   @XmlElement(name = "EnablePasswordPolicy", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean enablePasswordPolicy;
   @XmlElement(name = "EnableTSAudit", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean enableTSAudit;
   @XmlElement(name = "EnableWebServicesIPCheck", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean enableWebServicesIPCheck;
   @XmlElement(name = "ExceptionSiteList") protected String exceptionSiteList;
   ...
   @XmlElement(name = "GatewayUnifierEnabled", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean gatewayUnifierEnabled;
   ...
   @XmlElement(name = "HoursPerDay", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) protected Double hoursPerDay;
   @XmlElement(name = "HoursPerMonth", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) protected Double hoursPerMonth;
   @XmlElement(name = "HoursPerWeek", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) protected Double hoursPerWeek;
   @XmlElement(name = "HoursPerYear", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) protected Double hoursPerYear;
   @XmlElement(name = "IPSiteList") protected String ipSiteList;
   ...
   @XmlElement(name = "LogHoursAfterActualFinish", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean logHoursAfterActualFinish;
   @XmlElement(name = "LogHoursBeforeActualStart", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean logHoursBeforeActualStart;
   @XmlElement(name = "LogHoursCompletedActivities", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean logHoursCompletedActivities;
   @XmlElement(name = "LogHoursInFuture", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean logHoursInFuture;
   @XmlElement(name = "LogHoursNotStartedActivities", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean logHoursNotStartedActivities;
   ...
   @XmlElement(name = "MaxTimesheetResourceHours", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double maxTimesheetResourceHours;
   ...
   @XmlElement(name = "PrivateIPAllowList") protected String privateIPAllowList;
   @XmlElement(name = "ReportEnableLazyLoad", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean reportEnableLazyLoad;
   ...
   @XmlElement(name = "ResourcesCanAssignThemselvesToActivitiesOutsideTheirOBSAccess", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean resourcesCanAssignThemselvesToActivitiesOutsideTheirOBSAccess;
   @XmlElement(name = "StartDayOfWeek") protected Integer startDayOfWeek;
   @XmlElement(name = "SummarizeByCalendar", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean summarizeByCalendar;
   @XmlElement(name = "SummarizeByFinancialPeriods", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean summarizeByFinancialPeriods;
   ...
   @XmlElement(name = "TeamMemberConsentMessage") protected String teamMemberConsentMessage;
   @XmlElement(name = "TeamMemberEnableConsent") protected String teamMemberEnableConsent;
   ...
   @XmlElement(name = "TimesheetInterval", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean timesheetInterval;
   ...
   @XmlElement(name = "UnifierIntegrationPassword") protected String unifierIntegrationPassword;
   @XmlElement(name = "UnifierIntegrationUserName") protected String unifierIntegrationUserName;
   @XmlElement(name = "UnifierWebServiceURL") protected String unifierWebServiceURL;
   @XmlElement(name = "UseCalendarTimePeriodsFlag", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean useCalendarTimePeriodsFlag;
   @XmlElement(name = "UseMaxTimesheetResourceHours", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean useMaxTimesheetResourceHours;
   @XmlElement(name = "UseProjectManagerApproval") protected String useProjectManagerApproval;
   @XmlElement(name = "UseTimesheets", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean useTimesheets;
