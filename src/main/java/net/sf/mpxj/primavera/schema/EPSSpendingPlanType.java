...
}) public class EPSSpendingPlanType
{
   ...
   @XmlElement(name = "BenefitPlan", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double benefitPlan;
   ...
   @XmlElement(name = "Date", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "dateTime") protected Date date;
   ...
   @XmlElement(name = "SpendingPlan", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double spendingPlan;
