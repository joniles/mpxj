...
}) public class ActivityStepType
{
   ...
   @XmlElement(name = "PercentComplete", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double percentComplete;
   ...
   @XmlElement(name = "WeightPercent", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "double") protected Double weightPercent;
