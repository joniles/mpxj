...
}) public class GlobalReplaceType
{
   ...
   @XmlElement(name = "AllProjects", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean allProjects;
