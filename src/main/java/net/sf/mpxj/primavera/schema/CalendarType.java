 ...
 *                               &amp;lt;/simpleType&amp;gt;
 *                             &amp;lt;/element&amp;gt;
 *                             &amp;lt;element name="WorkTime" type="{http://xmlns.oracle.com/Primavera/P6/V20.12/API/BusinessObjects}WorkTimeType" maxOccurs="24"/&amp;gt;
 *                           &amp;lt;/sequence&amp;gt;
 *                         &amp;lt;/restriction&amp;gt;
 *                       &amp;lt;/complexContent&amp;gt;
 *                     &amp;lt;/complexType&amp;gt;
...
}) public class CalendarType
{
   ...
   @XmlElement(name = "IsDefault", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean isDefault;
   @XmlElement(name = "IsPersonal", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean isPersonal;
   ...
   }) public static class HolidayOrExceptions
   {
      ...
      }) public static class HolidayOrException
      {
         ...
         @XmlElement(name = "Date", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date date;
