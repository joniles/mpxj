...
}) public class ProjectPrivilegesType
{
   ...
   @XmlElement(name = "AddEditDeleteRisks", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteRisks;
   @XmlElement(name = "AddEPSActivityCodes", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEPSActivityCodes;
   @XmlElement(name = "AddEditActivitiesExceptRelationships", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditActivitiesExceptRelationships;
   @XmlElement(name = "AddEditProjectLevelLayouts", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditProjectLevelLayouts;
   @XmlElement(name = "AddEditDeleteTemplateDocuments", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteTemplateDocuments;
   @XmlElement(name = "AddProjectActivityCodes", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addProjectActivityCodes;
   @XmlElement(name = "AdministerProjectExternalApplications", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean administerProjectExternalApplications;
   @XmlElement(name = "ApplyActuals", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean applyActuals;
   @XmlElement(name = "ApproveTimesheetsAsProjectManager", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean approveTimesheetsAsProjectManager;
   @XmlElement(name = "AssignProjectBaselines", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean assignProjectBaselines;
   @XmlElement(name = "CheckInAndCheckOutProjects", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean checkInAndCheckOutProjects;
   @XmlElement(name = "AddProjects", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addProjects;
   @XmlElement(name = "AddEditWorkgroups", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditWorkgroups;
   @XmlElement(name = "DeleteEPSActivityCodes", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean deleteEPSActivityCodes;
   @XmlElement(name = "DeleteActivities", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean deleteActivities;
   @XmlElement(name = "DeleteProjectActivityCodes", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean deleteProjectActivityCodes;
   @XmlElement(name = "DeleteProjectDataWithTimesheetActuals", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean deleteProjectDataWithTimesheetActuals;
   @XmlElement(name = "DeleteProjects", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean deleteProjects;
   @XmlElement(name = "DeleteWorkgroups", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean deleteWorkgroups;
   @XmlElement(name = "EditActivityId", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editActivityId;
   @XmlElement(name = "EditCommittedFlagForResourcePlanning", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editCommittedFlagForResourcePlanning;
   @XmlElement(name = "EditEPSActivityCodes", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editEPSActivityCodes;
   @XmlElement(name = "AddEditDeleteEPSExceptCostsAndFinancials", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteEPSExceptCostsAndFinancials;
   @XmlElement(name = "EditEPSCostsAndFinancials", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editEPSCostsAndFinancials;
   @XmlElement(name = "EditFuturePeriods", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editFuturePeriods;
   @XmlElement(name = "EditPeriodPerformance", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editPeriodPerformance;
   @XmlElement(name = "EditProjectActivityCodes", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editProjectActivityCodes;
   @XmlElement(name = "AddEditDeleteActivityRelationships", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteActivityRelationships;
   @XmlElement(name = "AddEditDeleteProjectCalendars", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteProjectCalendars;
   @XmlElement(name = "EditContractManagementProjectLink", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editContractManagementProjectLink;
   @XmlElement(name = "EditProjectDetailsExceptCostsAndFinancials", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editProjectDetailsExceptCostsAndFinancials;
   @XmlElement(name = "AddEditDeleteExpenses", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteExpenses;
   @XmlElement(name = "EditProjectReports", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editProjectReports;
   @XmlElement(name = "AddEditDeleteIssuesAndIssueThreshold", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteIssuesAndIssueThreshold;
   @XmlElement(name = "AddEditDeleteWBSExceptCostsAndFinancials", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteWBSExceptCostsAndFinancials;
   @XmlElement(name = "EditWBSCostsAndFinancials", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editWBSCostsAndFinancials;
   @XmlElement(name = "AddEditDeleteWorkProductsAndDocuments", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteWorkProductsAndDocuments;
   @XmlElement(name = "AddEditDeleteResourceAssignmentsForResourcePlanning", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteResourceAssignmentsForResourcePlanning;
   @XmlElement(name = "AddEditDeleteRoleAssignmentsForResourcePlanning", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteRoleAssignmentsForResourcePlanning;
   @XmlElement(name = "ImportAndViewContractManagerData", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean importAndViewContractManagerData;
   @XmlElement(name = "LevelResources", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean levelResources;
   @XmlElement(name = "AddEditDeleteProjectBaselines", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteProjectBaselines;
   @XmlElement(name = "EditWorkspaceAndWorkgroupPreferences", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editWorkspaceAndWorkgroupPreferences;
   @XmlElement(name = "MonitorProjectThresholds", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean monitorProjectThresholds;
   @XmlElement(name = "AddEditActivityResourceRequests", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditActivityResourceRequests;
   @XmlElement(name = "PublishProjectWebsite", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean publishProjectWebsite;
   @XmlElement(name = "RunBaselineUpdate", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean runBaselineUpdate;
   @XmlElement(name = "RunGlobalChange", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean runGlobalChange;
   @XmlElement(name = "ScheduleProjects", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean scheduleProjects;
   @XmlElement(name = "StorePeriodPerformance", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean storePeriodPerformance;
   @XmlElement(name = "SummarizeProjects", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean summarizeProjects;
   @XmlElement(name = "ViewProjectCostsAndFinancials", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean viewProjectCostsAndFinancials;
   @XmlElement(name = "AddEditDeleteIssuesandIssueThresholds", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean addEditDeleteIssuesandIssueThresholds;
   @XmlElement(name = "AllowIntegrationwithERPSystem", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean allowIntegrationwithERPSystem;
   @XmlElement(name = "EditPublicationPriority", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean editPublicationPriority;
