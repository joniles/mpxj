...
}) public class RelationshipType
{
   ...
   @XmlElement(name = "Aref", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "dateTime") protected Date aref;
   @XmlElement(name = "Arls", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "dateTime") protected Date arls;
   ...
   @XmlElement(name = "Driving") protected Boolean driving;
   ...
   @XmlElement(name = "Lag", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) protected Double lag;
   ...
   @XmlElement(name = "PredecessorFinishDate", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "dateTime") protected Date predecessorFinishDate;
   ...
   @XmlElement(name = "PredecessorStartDate", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "dateTime") protected Date predecessorStartDate;
   ...
   @XmlElement(name = "SuccessorFinishDate", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "dateTime") protected Date successorFinishDate;
   ...
   @XmlElement(name = "SuccessorStartDate", type = String.class) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "dateTime") protected Date successorStartDate;
