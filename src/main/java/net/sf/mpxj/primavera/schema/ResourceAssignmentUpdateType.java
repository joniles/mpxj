...
public class ResourceAssignmentUpdateType {
    ...
    @XmlElement(name = "OverrideActualUnits", type = String.class, nillable = true)
    ...
    @XmlElement(name = "OverrideRemainingUnits", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter3 .class)
    ...
    @XmlElement(name = "PendingActualUnits", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter3 .class)
