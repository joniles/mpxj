...
}) public class ResourceAssignmentUpdateType
{
   ...
   @XmlElement(name = "OverrideRemainingFinishDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date overrideRemainingFinishDate;
   ...
   @XmlElement(name = "PendingRemainingFinishDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date pendingRemainingFinishDate;
