...
}) public class TimesheetType
{
   ...
   @XmlElement(name = "LastReceivedDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date lastReceivedDate;
   ...
   @XmlElement(name = "StatusDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date statusDate;
