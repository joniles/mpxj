...
}) public class TimesheetType
{
   ...
   @XmlElement(name = "IsDaily", type = String.class) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "boolean") protected Boolean isDaily;
   @XmlElement(name = "LastReceivedDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date lastReceivedDate;
   ...
   @XmlElement(name = "StatusDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date statusDate;
