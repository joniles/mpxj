...
}) public class FinancialPeriodTemplateType
{
   ...
   @XmlElement(name = "DefaultFlag", nillable = true) protected Boolean defaultFlag;
   @XmlElement(name = "FinancialPeriodTemplateName") protected String financialPeriodTemplateName;
   @XmlElement(name = "IsShortFinancialPeriod", nillable = true) protected Boolean isShortFinancialPeriod;
