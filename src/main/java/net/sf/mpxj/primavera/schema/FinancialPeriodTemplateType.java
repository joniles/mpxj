...
@XmlType(name = "FinancialPeriodTemplateType", propOrder = {
    "createDate",
    "createUser",
    "defaultFlag",
...
public class FinancialPeriodTemplateType {
    ...
    @XmlElement(name = "DefaultFlag", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter2 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean defaultFlag;
    @XmlElement(name = "FinancialPeriodTemplateName")
    @XmlJavaTypeAdapter(Adapter1 .class)
    protected String financialPeriodTemplateName;
    @XmlElement(name = "IsShortFinancialPeriod", type = String.class, nillable = true)
    @XmlJavaTypeAdapter(Adapter2 .class)
    @XmlSchemaType(name = "boolean")
    protected Boolean isShortFinancialPeriod;
    ...
    @XmlElement(name = "UsedByCount", nillable = true)
    protected Integer usedByCount;
