...
}) public class UserConsentType
{
   ...
   @XmlElement(name = "ConsentAcceptanceDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter1.class) @XmlSchemaType(name = "dateTime") protected Date consentAcceptanceDate;
