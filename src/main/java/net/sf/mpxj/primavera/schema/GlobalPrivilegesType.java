...
}) public class GlobalPrivilegesType
{
   ...
   @XmlElement(name = "AddRoleCodes") protected boolean addRoleCodes;
   ...
   @XmlElement(name = "DeleteRoleCodes") protected boolean deleteRoleCodes;
   ...
   @XmlElement(name = "EditRoleCodes") protected boolean editRoleCodes;
