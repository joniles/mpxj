...
}) public class ActivityStepCreateType
{
   ...
   @XmlElement(name = "StepPercentComplete", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double stepPercentComplete;
   @XmlElement(name = "StepWeight", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double stepWeight;
