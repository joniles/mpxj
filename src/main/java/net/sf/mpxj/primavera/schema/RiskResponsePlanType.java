...
}) public class RiskResponsePlanType
{
   ...
   @XmlElement(name = "PlannedFinishDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date plannedFinishDate;
