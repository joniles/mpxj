...
}) public class RiskResponsePlanType
{
   ...
   @XmlElement(name = "PlannedFinishDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter4.class) @XmlSchemaType(name = "dateTime") protected Date plannedFinishDate;
