...
}) public class UserDefinedValueUpdateType
{
   ...
   @XmlElement(name = "OverrideUdfCodeId", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double overrideUdfCodeId;
   @XmlElement(name = "OverrideUdfCost", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "double") protected Double overrideUdfCost;
   @XmlElement(name = "OverrideUdfEndDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date overrideUdfEndDate;
   @XmlElement(name = "OverrideUdfInteger", nillable = true) protected Integer overrideUdfInteger;
   @XmlElement(name = "OverrideUdfNumber", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double overrideUdfNumber;
   @XmlElement(name = "OverrideUdfStartDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date overrideUdfStartDate;
   ...
   @XmlElement(name = "PendingUdfCodeId", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double pendingUdfCodeId;
   @XmlElement(name = "PendingUdfCost", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) @XmlSchemaType(name = "double") protected Double pendingUdfCost;
   @XmlElement(name = "PendingUdfEndDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date pendingUdfEndDate;
   @XmlElement(name = "PendingUdfInteger", nillable = true) protected Integer pendingUdfInteger;
   @XmlElement(name = "PendingUdfNumber", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter2.class) protected Double pendingUdfNumber;
   @XmlElement(name = "PendingUdfStartDate", type = String.class, nillable = true) @XmlJavaTypeAdapter(Adapter3.class) @XmlSchemaType(name = "dateTime") protected Date pendingUdfStartDate;
