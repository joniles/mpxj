...
final class ResourceTypeHelper
{
   ...
   static
   {
      XML_TYPE_MAP.put(null, net.sf.mpxj.ResourceType.WORK);
      XML_TYPE_MAP.put("Labor", net.sf.mpxj.ResourceType.WORK);
      XML_TYPE_MAP.put("Material", net.sf.mpxj.ResourceType.MATERIAL);
      XML_TYPE_MAP.put("Nonlabor", net.sf.mpxj.ResourceType.COST);
   }

   private static final Map<ResourceType, String> TYPE_XML_MAP = new HashMap<>();
   static
   {
      TYPE_XML_MAP.put(net.sf.mpxj.ResourceType.WORK, "Labor");
      TYPE_XML_MAP.put(net.sf.mpxj.ResourceType.MATERIAL, "Material");
      TYPE_XML_MAP.put(net.sf.mpxj.ResourceType.COST, "Nonlabor");
   }
