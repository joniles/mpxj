...
public final class PrimaveraDatabaseReader extends AbstractProjectReader
{
   ...
   private void processTasks() throws SQLException
   {
      ...
      Map<Integer, Notes> wbsNotes = m_reader.getNotes(getRows("select * from " + m_schema + "wbsmemo where proj_id=?", m_projectID), "wbs_id", "wbs_memo");
      Map<Integer, Notes> taskNotes = m_reader.getNotes(getRows("select * from " + m_schema + "taskmemo where proj_id=?", m_projectID), "task_id", "task_memo");
