...
public enum ProjectField implements FieldType
{
   ...
   WHEN_SCHEDULING_PROGRESSED_ACTIVITIES_USE_RETAINED_LOGIC(DataType.BOOLEAN),
   WHEN_SCHEDULING_PROGRESSED_ACTIVITIES_USE_PROGRESS_OVERRIDE(DataType.BOOLEAN),
   ...
   CALCULATE_MULTIPLE_PATHS_USING_TOTAL_FLOAT(DataType.BOOLEAN),
   DISPLAY_MULTIPLE_FLOAT_PATHS_ENDING_WITH_ACTIVITY(DataType.INTEGER),
   LIMIT_NUMBER_OF_PATHS_TO_CALCULATE(DataType.BOOLEAN),
   NUMBER_OF_PATHS_TO_CALCULATE(DataType.INTEGER);
