...
public enum ProjectField implements FieldType
{
   ...
   RESOURCE_RATE1_NAME(DataType.STRING),
   RESOURCE_RATE2_NAME(DataType.STRING),
   RESOURCE_RATE3_NAME(DataType.STRING),
   RESOURCE_RATE4_NAME(DataType.STRING),
   RESOURCE_RATE5_NAME(DataType.STRING),
