...
}) @XmlRootElement(name = "Document") public class Document
{
   ...
   }) public static class Resources
   {
      ...
      }) public static class Resource
      {
         ...
         @XmlElement(name = "Name", required = true) protected String name;
         @XmlElement(name = "Type", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter12.class) protected net.sf.mpxj.ResourceType type;
         @XmlElement(name = "SubType", required = true, type = String.class) @XmlJavaTypeAdapter(Adapter13.class) protected net.sf.mpxj.ResourceType subType;
