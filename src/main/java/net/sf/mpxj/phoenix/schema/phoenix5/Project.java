...
public class Project {
    ...
    public static class Filters {
        ...
        public static class Filter {
            ...
            protected Project.Filters.Filter.ContainerCriteria containerCriteria;
            ...
            public static class ContainerCriteria {
                ...
                protected Project.Filters.Filter.ContainerCriteria.BinaryCriteria binaryCriteria;
    ...
    public static class Layouts {
        ...
        protected List<Project.Layouts.GanttLayout> ganttLayout;
        @XmlElement(name = "network_layout", required = true)
        protected List<Project.Layouts.NetworkLayout> networkLayout;
        ...
        public List<Project.Layouts.GanttLayout> getGanttLayout() {
            if (ganttLayout == null) {
                ganttLayout = new ArrayList<Project.Layouts.GanttLayout>();
            }
        ...
        public List<Project.Layouts.NetworkLayout> getNetworkLayout() {
            if (networkLayout == null) {
                networkLayout = new ArrayList<Project.Layouts.NetworkLayout>();
            }
        ...
        public static class GanttLayout {
            ...
            protected Project.Layouts.GanttLayout.DateFormat dateFormat;
            @XmlElement(name = "page_layout", required = true)
            protected Project.Layouts.GanttLayout.PageLayout pageLayout;
            @XmlElement(required = true)
            protected Project.Layouts.GanttLayout.Currency currency;
            @XmlElement(required = true)
            protected Project.Layouts.GanttLayout.Timescale timescale;
            @XmlElement(required = true)
            protected Project.Layouts.GanttLayout.Bars bars;
            @XmlElement(name = "code_options", required = true)
            protected Project.Layouts.GanttLayout.CodeOptions codeOptions;
            @XmlElement(required = true)
            protected Project.Layouts.GanttLayout.Sort sort;
            @XmlElement(required = true)
            protected Project.Layouts.GanttLayout.Columns columns;
            @XmlElement(required = true)
            protected Project.Layouts.GanttLayout.Comparisons comparisons;
            ...
            public static class Bars {
                ...
                @XmlElement(required = true)
                protected List<Project.Layouts.GanttLayout.Bars.Bar> bar;
                ...
                public List<Project.Layouts.GanttLayout.Bars.Bar> getBar() {
                    if (bar == null) {
                        bar = new ArrayList<Project.Layouts.GanttLayout.Bars.Bar>();
                    }
                    return this.bar;
                }
                ...
                public static class Bar {
                    ...
                    protected List<Project.Layouts.GanttLayout.Bars.Bar.BarPoint> barPoint;
                    ...
                    public List<Project.Layouts.GanttLayout.Bars.Bar.BarPoint> getBarPoint() {
                        if (barPoint == null) {
                            barPoint = new ArrayList<Project.Layouts.GanttLayout.Bars.Bar.BarPoint>();
                        }
            ...
            public static class CodeOptions {
                ...
                protected List<Project.Layouts.GanttLayout.CodeOptions.CodeOption> codeOption;
                ...
                public List<Project.Layouts.GanttLayout.CodeOptions.CodeOption> getCodeOption() {
                    if (codeOption == null) {
                        codeOption = new ArrayList<Project.Layouts.GanttLayout.CodeOptions.CodeOption>();
                    }
            ...
            public static class Columns {
                ...
                @XmlElement(required = true)
                protected List<Project.Layouts.GanttLayout.Columns.Column> column;
                ...
                public List<Project.Layouts.GanttLayout.Columns.Column> getColumn() {
                    if (column == null) {
                        column = new ArrayList<Project.Layouts.GanttLayout.Columns.Column>();
                    }
                    return this.column;
                }
            ...
            public static class Comparisons {
                ...
                @XmlElement(required = true)
                protected Project.Layouts.GanttLayout.Comparisons.Comparison comparison;
            ...
            public static class Sort {
                ...
                protected Project.Layouts.GanttLayout.Sort.SortColumn sortColumn;
            ...
            public static class Timescale {
                ...
                @XmlElement(required = true)
                protected List<Project.Layouts.GanttLayout.Timescale.Tier> tier;
                ...
                public List<Project.Layouts.GanttLayout.Timescale.Tier> getTier() {
                    if (tier == null) {
                        tier = new ArrayList<Project.Layouts.GanttLayout.Timescale.Tier>();
                    }
                    return this.tier;
                }
        ...
        public static class NetworkLayout {
            ...
            @XmlElement(name = "date_format", required = true)
            protected Project.Layouts.NetworkLayout.DateFormat dateFormat;
            @XmlElement(name = "page_layout", required = true)
            protected Project.Layouts.NetworkLayout.PageLayout pageLayout;
            @XmlElement(required = true)
            protected Project.Layouts.NetworkLayout.Currency currency;
            @XmlElement(required = true)
            protected Project.Layouts.NetworkLayout.Timescale timescale;
            @XmlElement(required = true)
            protected Project.Layouts.NetworkLayout.Bars bars;
            @XmlElement(name = "code_options", required = true)
            protected Project.Layouts.NetworkLayout.CodeOptions codeOptions;
            @XmlElement(name = "network_lines", required = true)
            protected Project.Layouts.NetworkLayout.NetworkLines networkLines;
            @XmlElement(name = "network_start_node_dates", required = true)
            protected Project.Layouts.NetworkLayout.NetworkStartNodeDates networkStartNodeDates;
            @XmlElement(name = "network_finish_node_dates", required = true)
            protected Project.Layouts.NetworkLayout.NetworkFinishNodeDates networkFinishNodeDates;
            @XmlAttribute(name = "name")
            protected String name;
            @XmlAttribute(name = "active_storepoint")
            protected String activeStorepoint;
            ...
            public static class Bars {
                ...
                @XmlElement(required = true)
                protected List<Project.Layouts.NetworkLayout.Bars.Bar> bar;
                ...
                public List<Project.Layouts.NetworkLayout.Bars.Bar> getBar() {
                    if (bar == null) {
                        bar = new ArrayList<Project.Layouts.NetworkLayout.Bars.Bar>();
                    }
                    return this.bar;
                }
                ...
                public static class Bar {
                    ...
                    @XmlElement(name = "bar_point", required = true)
                    protected List<Project.Layouts.NetworkLayout.Bars.Bar.BarPoint> barPoint;
                    @XmlAttribute(name = "brush_background_color")
                    protected String brushBackgroundColor;
                    @XmlAttribute(name = "brush_foreground_color")
                    protected String brushForegroundColor;
                    ...
                    public List<Project.Layouts.NetworkLayout.Bars.Bar.BarPoint> getBarPoint() {
                        if (barPoint == null) {
                            barPoint = new ArrayList<Project.Layouts.NetworkLayout.Bars.Bar.BarPoint>();
                        }
                        return this.barPoint;
                    }
            ...
            public static class CodeOptions {
                ...
                @XmlElement(name = "code_option", required = true)
                protected List<Project.Layouts.NetworkLayout.CodeOptions.CodeOption> codeOption;
                ...
                public List<Project.Layouts.NetworkLayout.CodeOptions.CodeOption> getCodeOption() {
                    if (codeOption == null) {
                        codeOption = new ArrayList<Project.Layouts.NetworkLayout.CodeOptions.CodeOption>();
                    }
                    return this.codeOption;
                }
            ...
            public static class NetworkFinishNodeDates {
                ...
                protected List<Project.Layouts.NetworkLayout.NetworkFinishNodeDates.NodeDate> nodeDate;
                ...
                public List<Project.Layouts.NetworkLayout.NetworkFinishNodeDates.NodeDate> getNodeDate() {
                    if (nodeDate == null) {
                        nodeDate = new ArrayList<Project.Layouts.NetworkLayout.NetworkFinishNodeDates.NodeDate>();
                    }
            ...
            public static class NetworkLines {
                ...
                protected List<Project.Layouts.NetworkLayout.NetworkLines.NetworkActivity> networkActivity;
                ...
                public List<Project.Layouts.NetworkLayout.NetworkLines.NetworkActivity> getNetworkActivity() {
                    if (networkActivity == null) {
                        networkActivity = new ArrayList<Project.Layouts.NetworkLayout.NetworkLines.NetworkActivity>();
                    }
            ...
            public static class NetworkStartNodeDates {
                ...
                @XmlElement(name = "node_date", required = true)
                protected List<Project.Layouts.NetworkLayout.NetworkStartNodeDates.NodeDate> nodeDate;
                ...
                public List<Project.Layouts.NetworkLayout.NetworkStartNodeDates.NodeDate> getNodeDate() {
                    if (nodeDate == null) {
                        nodeDate = new ArrayList<Project.Layouts.NetworkLayout.NetworkStartNodeDates.NodeDate>();
                    }
                    return this.nodeDate;
                }
            ...
            public static class Timescale {
                ...
                @XmlElement(required = true)
                protected List<Project.Layouts.NetworkLayout.Timescale.Tier> tier;
                ...
                public List<Project.Layouts.NetworkLayout.Timescale.Tier> getTier() {
                    if (tier == null) {
                        tier = new ArrayList<Project.Layouts.NetworkLayout.Timescale.Tier>();
                    }
                    return this.tier;
                }
