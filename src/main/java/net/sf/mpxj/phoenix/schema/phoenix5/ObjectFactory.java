 ...
 * generated in the net.sf.mpxj.phoenix.schema.phoenix5 package.
...
@XmlRegistry public class ObjectFactory
{
   ...
   /**
    * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.sf.mpxj.phoenix.schema.phoenix5
    * 
    */
