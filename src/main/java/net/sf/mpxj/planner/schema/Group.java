...
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "") @XmlRootElement(name = "group") public class Group
{
   ...
   @XmlAttribute(name = "admin-name") protected String adminName;
   @XmlAttribute(name = "admin-email") protected String adminEmail;
   @XmlAttribute(name = "admin-phone") protected String adminPhone;
