...
}) @XmlRootElement(name = "project") public class Project
{
   ...
   @XmlAttribute(name = "mrproject-version", required = true) protected String mrprojectVersion;
   @XmlAttribute(name = "name", required = true) protected String name;
   @XmlAttribute(name = "company") protected String company;
   @XmlAttribute(name = "manager") protected String manager;
   @XmlAttribute(name = "project-start", required = true) protected String projectStart;
   @XmlAttribute(name = "calendar") protected String calendar;
   @XmlAttribute(name = "phase") protected String phase;
