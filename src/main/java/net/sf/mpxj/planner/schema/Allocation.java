...
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "") @XmlRootElement(name = "allocation") public class Allocation
{
   ...
   @XmlAttribute(name = "task-id", required = true) protected String taskId;
   @XmlAttribute(name = "resource-id", required = true) protected String resourceId;
   @XmlAttribute(name = "units") protected String units;
