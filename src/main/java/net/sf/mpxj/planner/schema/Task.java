...
}) @XmlRootElement(name = "task") public class Task
{
   ...
   @XmlAttribute(name = "effort") protected String effort;
   @XmlAttribute(name = "start", required = true) protected String start;
   @XmlAttribute(name = "end", required = true) protected String end;
   @XmlAttribute(name = "work-start") protected String workStart;
   @XmlAttribute(name = "duration") protected String duration;
   @XmlAttribute(name = "work") protected String work;
   @XmlAttribute(name = "percent-complete") protected String percentComplete;
   @XmlAttribute(name = "priority") protected String priority;
