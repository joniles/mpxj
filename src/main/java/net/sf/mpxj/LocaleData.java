...
public final class LocaleData extends ListResourceBundle
{
   ...
   static
   {
      ...
      TASK_COLUMNS_ARRAY[TaskField.SHOW_START_TEXT.getValue()] = "Hide Start";
      TASK_COLUMNS_ARRAY[TaskField.SHOW_FINISH_TEXT.getValue()] = "Hide Finish";
      TASK_COLUMNS_ARRAY[TaskField.SHOW_DURATION_TEXT.getValue()] = "Hide Duration";
