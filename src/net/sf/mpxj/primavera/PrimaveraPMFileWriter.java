...
public final class PrimaveraPMFileWriter extends AbstractProjectWriter
{
   ...
   private void writeProjectProperties()
   {
      ...
      m_project.getUDF().addAll(writeUDFType(ProjectField.class, mpxj));
   }
   ...
   private void writeResource(Resource mpxj)
   {
      ...
      xml.getUDF().addAll(writeUDFType(ResourceField.class, mpxj));
   }
   ...
   private void writeActivity(Task mpxj)
   {
      ...
      xml.getUDF().addAll(writeUDFType(TaskField.class, mpxj));
   ...
   private void writeAssignment(ResourceAssignment mpxj)
   {
      ...
      xml.getUDF().addAll(writeUDFType(AssignmentField.class, mpxj));
   }
    ...
    * @author lsong
    */
   private List<UDFAssignmentType> writeUDFType(Class<?> type, FieldContainer mpxj)
   {
      LinkedList<UDFAssignmentType> out = new LinkedList<UDFAssignmentType>();
      CustomFieldContainer customFields = m_projectFile.getCustomFields();
      for (CustomField cf : customFields)
      {
         FieldType fieldType = cf.getFieldType();
         if (type.isInstance(fieldType))
         {
