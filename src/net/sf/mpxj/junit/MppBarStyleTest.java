...
import net.sf.mpxj.mpp.GanttBarMiddlePattern;
...
public class MppBarStyleTest extends MPXJTestCase
{
   ...
   private static final Object[][] DEFAULT_BAR_STYLES =
   {
...

      {
         ...
         GanttBarMiddlePattern.VERTICALSTRIPE,
         ColorType.BLUE,
         GanttBarStartEndShape.NONE,
         GanttBarStartEndType.SOLID,
         ColorType.BLACK,
...

      {
         ...
         ColorType.BLACK,
         GanttBarMiddleShape.ROUNDED,
         GanttBarMiddlePattern.HORIZONTALSTRIPE,
         ColorType.AUTOMATIC,
         GanttBarStartEndShape.NONE,
         GanttBarStartEndType.SOLID,
         ColorType.BLACK,
...

      {
         ...
         ColorType.BLACK,
         GanttBarMiddleShape.ROUNDED,
         GanttBarMiddlePattern.TRANSPARENT,
         ColorType.BLACK,
         GanttBarStartEndShape.SOUTHHOMEPLATE,
...

      {
         ...
         ColorType.BLACK,
         GanttBarMiddleShape.NONE,
         GanttBarMiddlePattern.LIGHTDOTTED,
         ColorType.LIME,
...

      {
         ...
         GanttBarMiddlePattern.HEAVYDOTTED,
         ColorType.WHITE,
         GanttBarStartEndShape.DOWNPOINTER,
         GanttBarStartEndType.SOLID,
         ColorType.MAROON,
...

      {
         ...
         ColorType.GREEN,
         GanttBarMiddleShape.TOPLINE,
         GanttBarMiddlePattern.BACKSLASH,
         ColorType.OLIVE,
...

      {
         ...
         GanttBarMiddlePattern.FORWARDSLASH,
         ColorType.TEAL,
         GanttBarStartEndShape.NORTHMINIHOMEPLATE,
         GanttBarStartEndType.SOLID,
         ColorType.GRAY,
...

      {
         ...
         ColorType.BLACK,
         GanttBarMiddleShape.BOTTOMLINE,
         GanttBarMiddlePattern.CHECKERED,
         ColorType.SILVER,
   ...
   private static final Object[][] DEFAULT_BAR_STYLES14 =
   {
...

      {
         ...
         ColorType.BLACK,
         GanttBarMiddleShape.ROUNDED,
         GanttBarMiddlePattern.SOLIDHAIRY,
         new Color(19, 154, 161),
         GanttBarStartEndShape.RIGHTBRACKET,
         GanttBarStartEndType.SOLID,
         ColorType.BLACK,
