...
public class PhasesImpl implements net.sf.mpxj.planner.schema.Phases, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, net.sf.mpxj.planner.schema.impl.runtime.UnmarshallableObject, net.sf.mpxj.planner.schema.impl.runtime.XMLSerializable, net.sf.mpxj.planner.schema.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (net.sf.mpxj.planner.schema.Phases.class);
    }
    ...
    public net.sf.mpxj.planner.schema.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sf.mpxj.planner.schema.impl.runtime.UnmarshallingContext context) {
        return new net.sf.mpxj.planner.schema.impl.PhasesImpl.Unmarshaller(context);
    }
...
+"ceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u0000 net.sf.mpxj.planner.schema.Phaset\u0000+http:/"
+"/java.sun.com/jaxb/xjc/dummy-elementsq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\u0006phasest\u0000\u0000"
...
+"ool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000\u0010q\u0000~\u0000\u0011x"));
        ...
        extends net.sf.mpxj.planner.schema.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sf.mpxj.planner.schema.impl.PhasesImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("phase" == ___local)&&("" == ___uri)) {
                            _getPhase().add(((net.sf.mpxj.planner.schema.impl.PhaseImpl) spawnChildFromEnterElement((net.sf.mpxj.planner.schema.impl.PhaseImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        state = 2;
                        continue outer;
