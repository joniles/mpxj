...
public class DayTypesImpl implements net.sf.mpxj.planner.schema.DayTypes, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, net.sf.mpxj.planner.schema.impl.runtime.UnmarshallableObject, net.sf.mpxj.planner.schema.impl.runtime.XMLSerializable, net.sf.mpxj.planner.schema.impl.runtime.ValidatableObject
{
    ...
    protected com.sun.xml.bind.util.ListImpl _getDayType() {
        if (_DayType == null) {
            _DayType = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _DayType;
    }

    public java.util.List getDayType() {
        return _getDayType();
    }
    ...
    public net.sf.mpxj.planner.schema.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sf.mpxj.planner.schema.impl.runtime.UnmarshallingContext context) {
        return new net.sf.mpxj.planner.schema.impl.DayTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_DayType == null)? 0 :_DayType.size());
        context.startElement("", "day-types");
        int idx_0 = idx1;
        while (idx_0 != len1) {
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _DayType.get(idx_0 ++)), "DayType");
        }
        context.endNamespaceDecls();
        int idx_1 = idx1;
        while (idx_1 != len1) {
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _DayType.get(idx_1 ++)), "DayType");
        }
        context.endAttributes();
        while (idx1 != len1) {
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _DayType.get(idx1 ++)), "DayType");
        }
        context.endElement();
    }
...
+"ceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u0000\"net.sf.mpxj.planner.schema.DayTypet\u0000+http"
+"://java.sun.com/jaxb/xjc/dummy-elementsq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\tday-typ"
+"est\u0000\u0000sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\bexp"
...
+"sionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000\u0010q\u0000~\u0000\u0011x"));
        ...
        extends net.sf.mpxj.planner.schema.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sf.mpxj.planner.schema.impl.DayTypesImpl.this;
        }
                ...
                switch (state) {
                    case  2 :
                        if (("day-type" == ___local)&&("" == ___uri)) {
                            _getDayType().add(((net.sf.mpxj.planner.schema.impl.DayTypeImpl) spawnChildFromEnterElement((net.sf.mpxj.planner.schema.impl.DayTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
