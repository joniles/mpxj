...
public class PredecessorsImpl implements net.sf.mpxj.planner.schema.Predecessors, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, net.sf.mpxj.planner.schema.impl.runtime.UnmarshallableObject, net.sf.mpxj.planner.schema.impl.runtime.XMLSerializable, net.sf.mpxj.planner.schema.impl.runtime.ValidatableObject
{
    ...
    protected com.sun.xml.bind.util.ListImpl _getPredecessor() {
        if (_Predecessor == null) {
            _Predecessor = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Predecessor;
    }

    public java.util.List getPredecessor() {
        return _getPredecessor();
    }
    ...
    public net.sf.mpxj.planner.schema.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sf.mpxj.planner.schema.impl.runtime.UnmarshallingContext context) {
        return new net.sf.mpxj.planner.schema.impl.PredecessorsImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Predecessor == null)? 0 :_Predecessor.size());
        context.startElement("", "predecessors");
        int idx_0 = idx1;
        while (idx_0 != len1) {
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Predecessor.get(idx_0 ++)), "Predecessor");
        }
        context.endNamespaceDecls();
        int idx_1 = idx1;
        while (idx_1 != len1) {
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Predecessor.get(idx_1 ++)), "Predecessor");
        }
        context.endAttributes();
        while (idx1 != len1) {
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Predecessor.get(idx1 ++)), "Predecessor");
        }
        context.endElement();
    }
...
+"ceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u0000&net.sf.mpxj.planner.schema.Predecessort\u0000+"
+"http://java.sun.com/jaxb/xjc/dummy-elementsq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\fpre"
+"decessorst\u0000\u0000sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000"
...
+"/ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000\u0010q\u0000~\u0000\u0011x"));
        ...
        extends net.sf.mpxj.planner.schema.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sf.mpxj.planner.schema.impl.PredecessorsImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  2 :
                        if (("predecessor" == ___local)&&("" == ___uri)) {
                            _getPredecessor().add(((net.sf.mpxj.planner.schema.impl.PredecessorImpl) spawnChildFromEnterElement((net.sf.mpxj.planner.schema.impl.PredecessorImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  1 :
