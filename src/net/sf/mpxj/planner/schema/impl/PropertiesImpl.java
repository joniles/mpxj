...
public class PropertiesImpl implements net.sf.mpxj.planner.schema.Properties, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, net.sf.mpxj.planner.schema.impl.runtime.UnmarshallableObject, net.sf.mpxj.planner.schema.impl.runtime.XMLSerializable, net.sf.mpxj.planner.schema.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (net.sf.mpxj.planner.schema.Properties.class);
    }
    ...
    public net.sf.mpxj.planner.schema.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sf.mpxj.planner.schema.impl.runtime.UnmarshallingContext context) {
        return new net.sf.mpxj.planner.schema.impl.PropertiesImpl.Unmarshaller(context);
    }
...
+"ceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u0000#net.sf.mpxj.planner.schema.Propertyt\u0000+htt"
+"p://java.sun.com/jaxb/xjc/dummy-elementsq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\nproper"
+"tiest\u0000\u0000sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\be"
...
+"essionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000\u0010q\u0000~\u0000\u0011x"));
        ...
        extends net.sf.mpxj.planner.schema.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sf.mpxj.planner.schema.impl.PropertiesImpl.this;
        }
                ...
                switch (state) {
                    case  2 :
                        if (("property" == ___local)&&("" == ___uri)) {
                            _getProperty().add(((net.sf.mpxj.planner.schema.impl.PropertyImpl) spawnChildFromEnterElement((net.sf.mpxj.planner.schema.impl.PropertyImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  1 :
