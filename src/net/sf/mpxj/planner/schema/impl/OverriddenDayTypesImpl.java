...
public class OverriddenDayTypesImpl implements net.sf.mpxj.planner.schema.OverriddenDayTypes, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, net.sf.mpxj.planner.schema.impl.runtime.UnmarshallableObject, net.sf.mpxj.planner.schema.impl.runtime.XMLSerializable, net.sf.mpxj.planner.schema.impl.runtime.ValidatableObject
{
    ...
    public java.lang.String ____jaxb_ri____getLocalName() {
        return "overridden-day-types";
    }

    protected com.sun.xml.bind.util.ListImpl _getOverriddenDayType() {
        if (_OverriddenDayType == null) {
            _OverriddenDayType = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _OverriddenDayType;
    }

    public java.util.List getOverriddenDayType() {
        return _getOverriddenDayType();
    }
    ...
    public net.sf.mpxj.planner.schema.impl.runtime.UnmarshallingEventHandler createUnmarshaller(net.sf.mpxj.planner.schema.impl.runtime.UnmarshallingContext context) {
        return new net.sf.mpxj.planner.schema.impl.OverriddenDayTypesImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_OverriddenDayType == null)? 0 :_OverriddenDayType.size());
        context.startElement("", "overridden-day-types");
        int idx_0 = idx1;
        while (idx_0 != len1) {
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _OverriddenDayType.get(idx_0 ++)), "OverriddenDayType");
        }
        context.endNamespaceDecls();
        int idx_1 = idx1;
        while (idx_1 != len1) {
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _OverriddenDayType.get(idx_1 ++)), "OverriddenDayType");
        }
        context.endAttributes();
        while (idx1 != len1) {
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _OverriddenDayType.get(idx1 ++)), "OverriddenDayType");
        }
        context.endElement();
    }
...
+"ceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u0000,net.sf.mpxj.planner.schema.OverriddenDayT"
+"ypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elementsq\u0000~\u0000\u001bsq\u0000~\u0000\u001c"
+"t\u0000\u0014overridden-day-typest\u0000\u0000sr\u0000\"com.sun.msv.grammar.Expression"
...
+"un/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0004\u0001pq\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000\u0010q\u0000~\u0000\u0011x"));
        }
        ...
        extends net.sf.mpxj.planner.schema.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return net.sf.mpxj.planner.schema.impl.OverriddenDayTypesImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  2 :
                        if (("overridden-day-type" == ___local)&&("" == ___uri)) {
                            _getOverriddenDayType().add(((net.sf.mpxj.planner.schema.impl.OverriddenDayTypeImpl) spawnChildFromEnterElement((net.sf.mpxj.planner.schema.impl.OverriddenDayTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :
