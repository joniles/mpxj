   ...
   /*   
      private void coalesceAssignments (ProjectCalendar calendar, List<TimephasedResourceAssignment> list)
      {
         ...
         for (TimephasedResourceAssignment assignment : list)
         {
            ...
            {
               Date assignmentFinish = previousAssignment.getFinish();
               Date assignmentStart = assignment.getStart();
               Date assignmentFinishDay = DateUtility.getDayStartDate(assignmentFinish);
               Date assignmentStartDay = DateUtility.getDayEndDate(assignmentStart);
               
               if (assignmentFinishDay.getTime() != assignmentStartDay.getTime())
               {
               ...
               else
               {
                  ...
                  // a new one. The exception here is when the first assignemnt is only
