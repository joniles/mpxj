...
Regular Work| | | | | | | | |✓| | |✓| | | | | | | | | | | | | 
Remaining Cost| | | | | | | | |✓|✓|✓|✓| | | |✓|✓|✓| | |✓| | | | 
Remaining Cost Expense| | | | | | | | | | | | | | | |✓|✓|✓| | | | | | | 
Remaining Cost Labor| | | | | | | | | | | | | | | |✓|✓|✓| | | | | | | 
Remaining Cost Material| | | | | | | | | | | | | | | |✓| |✓| | | | | | | 
Remaining Cost Non Labor| | | | | | | | | | | | | | | |✓| |✓| | | | | | | 
Remaining Duration|✓| |✓|✓| | | | |✓|✓|✓|✓|✓|✓| |✓|✓|✓| |✓|✓| |✓|✓| 
