...
public class BasicTest
{
   ...
   {
      AliasContainer<TaskField> taskFieldAliases = mpx.getTaskFieldAliases();

      assertEquals("Text1t", taskFieldAliases.getAlias(TaskField.TEXT1));
      assertEquals("Text2t", taskFieldAliases.getAlias(TaskField.TEXT2));
      assertEquals("Text3t", taskFieldAliases.getAlias(TaskField.TEXT3));
      assertEquals("Text4t", taskFieldAliases.getAlias(TaskField.TEXT4));
      assertEquals("Text5t", taskFieldAliases.getAlias(TaskField.TEXT5));
      assertEquals("Text6t", taskFieldAliases.getAlias(TaskField.TEXT6));
      assertEquals("Text7t", taskFieldAliases.getAlias(TaskField.TEXT7));
      assertEquals("Text8t", taskFieldAliases.getAlias(TaskField.TEXT8));
      assertEquals("Text9t", taskFieldAliases.getAlias(TaskField.TEXT9));
      assertEquals("Text10t", taskFieldAliases.getAlias(TaskField.TEXT10));
      assertEquals("Text11t", taskFieldAliases.getAlias(TaskField.TEXT11));
      assertEquals("Text12t", taskFieldAliases.getAlias(TaskField.TEXT12));
      assertEquals("Text13t", taskFieldAliases.getAlias(TaskField.TEXT13));
      assertEquals("Text14t", taskFieldAliases.getAlias(TaskField.TEXT14));
      assertEquals("Text15t", taskFieldAliases.getAlias(TaskField.TEXT15));
      assertEquals("Text16t", taskFieldAliases.getAlias(TaskField.TEXT16));
      assertEquals("Text17t", taskFieldAliases.getAlias(TaskField.TEXT17));
      assertEquals("Text18t", taskFieldAliases.getAlias(TaskField.TEXT18));
      assertEquals("Text19t", taskFieldAliases.getAlias(TaskField.TEXT19));
      assertEquals("Text20t", taskFieldAliases.getAlias(TaskField.TEXT20));
      assertEquals("Text21t", taskFieldAliases.getAlias(TaskField.TEXT21));
      assertEquals("Text22t", taskFieldAliases.getAlias(TaskField.TEXT22));
      assertEquals("Text23t", taskFieldAliases.getAlias(TaskField.TEXT23));
      assertEquals("Text24t", taskFieldAliases.getAlias(TaskField.TEXT24));
      assertEquals("Text25t", taskFieldAliases.getAlias(TaskField.TEXT25));
      assertEquals("Text26t", taskFieldAliases.getAlias(TaskField.TEXT26));
      assertEquals("Text27t", taskFieldAliases.getAlias(TaskField.TEXT27));
      assertEquals("Text28t", taskFieldAliases.getAlias(TaskField.TEXT28));
      assertEquals("Text29t", taskFieldAliases.getAlias(TaskField.TEXT29));
      assertEquals("Text30t", taskFieldAliases.getAlias(TaskField.TEXT30));
      assertEquals("Start1t", taskFieldAliases.getAlias(TaskField.START1));
      assertEquals("Start2t", taskFieldAliases.getAlias(TaskField.START2));
      assertEquals("Start3t", taskFieldAliases.getAlias(TaskField.START3));
      assertEquals("Start4t", taskFieldAliases.getAlias(TaskField.START4));
      assertEquals("Start5t", taskFieldAliases.getAlias(TaskField.START5));
      assertEquals("Start6t", taskFieldAliases.getAlias(TaskField.START6));
      assertEquals("Start7t", taskFieldAliases.getAlias(TaskField.START7));
      assertEquals("Start8t", taskFieldAliases.getAlias(TaskField.START8));
      assertEquals("Start9t", taskFieldAliases.getAlias(TaskField.START9));
      assertEquals("Start10t", taskFieldAliases.getAlias(TaskField.START10));
      assertEquals("Finish1t", taskFieldAliases.getAlias(TaskField.FINISH1));
      assertEquals("Finish2t", taskFieldAliases.getAlias(TaskField.FINISH2));
      assertEquals("Finish3t", taskFieldAliases.getAlias(TaskField.FINISH3));
      assertEquals("Finish4t", taskFieldAliases.getAlias(TaskField.FINISH4));
      assertEquals("Finish5t", taskFieldAliases.getAlias(TaskField.FINISH5));
      assertEquals("Finish6t", taskFieldAliases.getAlias(TaskField.FINISH6));
      assertEquals("Finish7t", taskFieldAliases.getAlias(TaskField.FINISH7));
      assertEquals("Finish8t", taskFieldAliases.getAlias(TaskField.FINISH8));
      assertEquals("Finish9t", taskFieldAliases.getAlias(TaskField.FINISH9));
      assertEquals("Finish10t", taskFieldAliases.getAlias(TaskField.FINISH10));
      assertEquals("Cost1t", taskFieldAliases.getAlias(TaskField.COST1));
      assertEquals("Cost2t", taskFieldAliases.getAlias(TaskField.COST2));
      assertEquals("Cost3t", taskFieldAliases.getAlias(TaskField.COST3));
      assertEquals("Cost4t", taskFieldAliases.getAlias(TaskField.COST4));
      assertEquals("Cost5t", taskFieldAliases.getAlias(TaskField.COST5));
      assertEquals("Cost6t", taskFieldAliases.getAlias(TaskField.COST6));
      assertEquals("Cost7t", taskFieldAliases.getAlias(TaskField.COST7));
      assertEquals("Cost8t", taskFieldAliases.getAlias(TaskField.COST8));
      assertEquals("Cost9t", taskFieldAliases.getAlias(TaskField.COST9));
      assertEquals("Cost10t", taskFieldAliases.getAlias(TaskField.COST10));
      assertEquals("Date1t", taskFieldAliases.getAlias(TaskField.DATE1));
      assertEquals("Date2t", taskFieldAliases.getAlias(TaskField.DATE2));
      assertEquals("Date3t", taskFieldAliases.getAlias(TaskField.DATE3));
      assertEquals("Date4t", taskFieldAliases.getAlias(TaskField.DATE4));
      assertEquals("Date5t", taskFieldAliases.getAlias(TaskField.DATE5));
      assertEquals("Date6t", taskFieldAliases.getAlias(TaskField.DATE6));
      assertEquals("Date7t", taskFieldAliases.getAlias(TaskField.DATE7));
      assertEquals("Date8t", taskFieldAliases.getAlias(TaskField.DATE8));
      assertEquals("Date9t", taskFieldAliases.getAlias(TaskField.DATE9));
      assertEquals("Date10t", taskFieldAliases.getAlias(TaskField.DATE10));
      assertEquals("Flag1t", taskFieldAliases.getAlias(TaskField.FLAG1));
      assertEquals("Flag2t", taskFieldAliases.getAlias(TaskField.FLAG2));
      assertEquals("Flag3t", taskFieldAliases.getAlias(TaskField.FLAG3));
      assertEquals("Flag4t", taskFieldAliases.getAlias(TaskField.FLAG4));
      assertEquals("Flag5t", taskFieldAliases.getAlias(TaskField.FLAG5));
      assertEquals("Flag6t", taskFieldAliases.getAlias(TaskField.FLAG6));
      assertEquals("Flag7t", taskFieldAliases.getAlias(TaskField.FLAG7));
      assertEquals("Flag8t", taskFieldAliases.getAlias(TaskField.FLAG8));
      assertEquals("Flag9t", taskFieldAliases.getAlias(TaskField.FLAG9));
      assertEquals("Flag10t", taskFieldAliases.getAlias(TaskField.FLAG10));
      assertEquals("Flag11t", taskFieldAliases.getAlias(TaskField.FLAG11));
      assertEquals("Flag12t", taskFieldAliases.getAlias(TaskField.FLAG12));
      assertEquals("Flag13t", taskFieldAliases.getAlias(TaskField.FLAG13));
      assertEquals("Flag14t", taskFieldAliases.getAlias(TaskField.FLAG14));
      assertEquals("Flag15t", taskFieldAliases.getAlias(TaskField.FLAG15));
      assertEquals("Flag16t", taskFieldAliases.getAlias(TaskField.FLAG16));
      assertEquals("Flag17t", taskFieldAliases.getAlias(TaskField.FLAG17));
      assertEquals("Flag18t", taskFieldAliases.getAlias(TaskField.FLAG18));
      assertEquals("Flag19t", taskFieldAliases.getAlias(TaskField.FLAG19));
      assertEquals("Flag20t", taskFieldAliases.getAlias(TaskField.FLAG20));
      assertEquals("Number1t", taskFieldAliases.getAlias(TaskField.NUMBER1));
      assertEquals("Number2t", taskFieldAliases.getAlias(TaskField.NUMBER2));
      assertEquals("Number3t", taskFieldAliases.getAlias(TaskField.NUMBER3));
      assertEquals("Number4t", taskFieldAliases.getAlias(TaskField.NUMBER4));
      assertEquals("Number5t", taskFieldAliases.getAlias(TaskField.NUMBER5));
      assertEquals("Number6t", taskFieldAliases.getAlias(TaskField.NUMBER6));
      assertEquals("Number7t", taskFieldAliases.getAlias(TaskField.NUMBER7));
      assertEquals("Number8t", taskFieldAliases.getAlias(TaskField.NUMBER8));
      assertEquals("Number9t", taskFieldAliases.getAlias(TaskField.NUMBER9));
      assertEquals("Number10t", taskFieldAliases.getAlias(TaskField.NUMBER10));
      assertEquals("Number11t", taskFieldAliases.getAlias(TaskField.NUMBER11));
      assertEquals("Number12t", taskFieldAliases.getAlias(TaskField.NUMBER12));
      assertEquals("Number13t", taskFieldAliases.getAlias(TaskField.NUMBER13));
      assertEquals("Number14t", taskFieldAliases.getAlias(TaskField.NUMBER14));
      assertEquals("Number15t", taskFieldAliases.getAlias(TaskField.NUMBER15));
      assertEquals("Number16t", taskFieldAliases.getAlias(TaskField.NUMBER16));
      assertEquals("Number17t", taskFieldAliases.getAlias(TaskField.NUMBER17));
      assertEquals("Number18t", taskFieldAliases.getAlias(TaskField.NUMBER18));
      assertEquals("Number19t", taskFieldAliases.getAlias(TaskField.NUMBER19));
      assertEquals("Number20t", taskFieldAliases.getAlias(TaskField.NUMBER20));
      assertEquals("Duration1t", taskFieldAliases.getAlias(TaskField.DURATION1));
      assertEquals("Duration2t", taskFieldAliases.getAlias(TaskField.DURATION2));
      assertEquals("Duration3t", taskFieldAliases.getAlias(TaskField.DURATION3));
      assertEquals("Duration4t", taskFieldAliases.getAlias(TaskField.DURATION4));
      assertEquals("Duration5t", taskFieldAliases.getAlias(TaskField.DURATION5));
      assertEquals("Duration6t", taskFieldAliases.getAlias(TaskField.DURATION6));
      assertEquals("Duration7t", taskFieldAliases.getAlias(TaskField.DURATION7));
      assertEquals("Duration8t", taskFieldAliases.getAlias(TaskField.DURATION8));
      assertEquals("Duration9t", taskFieldAliases.getAlias(TaskField.DURATION9));
      assertEquals("Duration10t", taskFieldAliases.getAlias(TaskField.DURATION10));
      assertEquals("Outline Code1t", taskFieldAliases.getAlias(TaskField.OUTLINE_CODE1));
      assertEquals("Outline Code2t", taskFieldAliases.getAlias(TaskField.OUTLINE_CODE2));
      assertEquals("Outline Code3t", taskFieldAliases.getAlias(TaskField.OUTLINE_CODE3));
      assertEquals("Outline Code4t", taskFieldAliases.getAlias(TaskField.OUTLINE_CODE4));
      assertEquals("Outline Code5t", taskFieldAliases.getAlias(TaskField.OUTLINE_CODE5));
      assertEquals("Outline Code6t", taskFieldAliases.getAlias(TaskField.OUTLINE_CODE6));
      assertEquals("Outline Code7t", taskFieldAliases.getAlias(TaskField.OUTLINE_CODE7));
      assertEquals("Outline Code8t", taskFieldAliases.getAlias(TaskField.OUTLINE_CODE8));
      assertEquals("Outline Code9t", taskFieldAliases.getAlias(TaskField.OUTLINE_CODE9));
      assertEquals("Outline Code10t", taskFieldAliases.getAlias(TaskField.OUTLINE_CODE10));

      AliasContainer<ResourceField> resourceFieldAliases = mpx.getResourceFieldAliases();

      assertEquals("Text1r", resourceFieldAliases.getAlias(ResourceField.TEXT1));
      assertEquals("Text2r", resourceFieldAliases.getAlias(ResourceField.TEXT2));
      assertEquals("Text3r", resourceFieldAliases.getAlias(ResourceField.TEXT3));
      assertEquals("Text4r", resourceFieldAliases.getAlias(ResourceField.TEXT4));
      assertEquals("Text5r", resourceFieldAliases.getAlias(ResourceField.TEXT5));
      assertEquals("Text6r", resourceFieldAliases.getAlias(ResourceField.TEXT6));
      assertEquals("Text7r", resourceFieldAliases.getAlias(ResourceField.TEXT7));
      assertEquals("Text8r", resourceFieldAliases.getAlias(ResourceField.TEXT8));
      assertEquals("Text9r", resourceFieldAliases.getAlias(ResourceField.TEXT9));
      assertEquals("Text10r", resourceFieldAliases.getAlias(ResourceField.TEXT10));
      assertEquals("Text11r", resourceFieldAliases.getAlias(ResourceField.TEXT11));
      assertEquals("Text12r", resourceFieldAliases.getAlias(ResourceField.TEXT12));
      assertEquals("Text13r", resourceFieldAliases.getAlias(ResourceField.TEXT13));
      assertEquals("Text14r", resourceFieldAliases.getAlias(ResourceField.TEXT14));
      assertEquals("Text15r", resourceFieldAliases.getAlias(ResourceField.TEXT15));
      assertEquals("Text16r", resourceFieldAliases.getAlias(ResourceField.TEXT16));
      assertEquals("Text17r", resourceFieldAliases.getAlias(ResourceField.TEXT17));
      assertEquals("Text18r", resourceFieldAliases.getAlias(ResourceField.TEXT18));
      assertEquals("Text19r", resourceFieldAliases.getAlias(ResourceField.TEXT19));
      assertEquals("Text20r", resourceFieldAliases.getAlias(ResourceField.TEXT20));
      assertEquals("Text21r", resourceFieldAliases.getAlias(ResourceField.TEXT21));
      assertEquals("Text22r", resourceFieldAliases.getAlias(ResourceField.TEXT22));
      assertEquals("Text23r", resourceFieldAliases.getAlias(ResourceField.TEXT23));
      assertEquals("Text24r", resourceFieldAliases.getAlias(ResourceField.TEXT24));
      assertEquals("Text25r", resourceFieldAliases.getAlias(ResourceField.TEXT25));
      assertEquals("Text26r", resourceFieldAliases.getAlias(ResourceField.TEXT26));
      assertEquals("Text27r", resourceFieldAliases.getAlias(ResourceField.TEXT27));
      assertEquals("Text28r", resourceFieldAliases.getAlias(ResourceField.TEXT28));
      assertEquals("Text29r", resourceFieldAliases.getAlias(ResourceField.TEXT29));
      assertEquals("Text30r", resourceFieldAliases.getAlias(ResourceField.TEXT30));
      assertEquals("Start1r", resourceFieldAliases.getAlias(ResourceField.START1));
      assertEquals("Start2r", resourceFieldAliases.getAlias(ResourceField.START2));
      assertEquals("Start3r", resourceFieldAliases.getAlias(ResourceField.START3));
      assertEquals("Start4r", resourceFieldAliases.getAlias(ResourceField.START4));
      assertEquals("Start5r", resourceFieldAliases.getAlias(ResourceField.START5));
      assertEquals("Start6r", resourceFieldAliases.getAlias(ResourceField.START6));
      assertEquals("Start7r", resourceFieldAliases.getAlias(ResourceField.START7));
      assertEquals("Start8r", resourceFieldAliases.getAlias(ResourceField.START8));
      assertEquals("Start9r", resourceFieldAliases.getAlias(ResourceField.START9));
      assertEquals("Start10r", resourceFieldAliases.getAlias(ResourceField.START10));
      assertEquals("Finish1r", resourceFieldAliases.getAlias(ResourceField.FINISH1));
      assertEquals("Finish2r", resourceFieldAliases.getAlias(ResourceField.FINISH2));
      assertEquals("Finish3r", resourceFieldAliases.getAlias(ResourceField.FINISH3));
      assertEquals("Finish4r", resourceFieldAliases.getAlias(ResourceField.FINISH4));
      assertEquals("Finish5r", resourceFieldAliases.getAlias(ResourceField.FINISH5));
      assertEquals("Finish6r", resourceFieldAliases.getAlias(ResourceField.FINISH6));
      assertEquals("Finish7r", resourceFieldAliases.getAlias(ResourceField.FINISH7));
      assertEquals("Finish8r", resourceFieldAliases.getAlias(ResourceField.FINISH8));
      assertEquals("Finish9r", resourceFieldAliases.getAlias(ResourceField.FINISH9));
      assertEquals("Finish10r", resourceFieldAliases.getAlias(ResourceField.FINISH10));
      assertEquals("Cost1r", resourceFieldAliases.getAlias(ResourceField.COST1));
      assertEquals("Cost2r", resourceFieldAliases.getAlias(ResourceField.COST2));
      assertEquals("Cost3r", resourceFieldAliases.getAlias(ResourceField.COST3));
      assertEquals("Cost4r", resourceFieldAliases.getAlias(ResourceField.COST4));
      assertEquals("Cost5r", resourceFieldAliases.getAlias(ResourceField.COST5));
      assertEquals("Cost6r", resourceFieldAliases.getAlias(ResourceField.COST6));
      assertEquals("Cost7r", resourceFieldAliases.getAlias(ResourceField.COST7));
      assertEquals("Cost8r", resourceFieldAliases.getAlias(ResourceField.COST8));
      assertEquals("Cost9r", resourceFieldAliases.getAlias(ResourceField.COST9));
      assertEquals("Cost10r", resourceFieldAliases.getAlias(ResourceField.COST10));
      assertEquals("Date1r", resourceFieldAliases.getAlias(ResourceField.DATE1));
      assertEquals("Date2r", resourceFieldAliases.getAlias(ResourceField.DATE2));
      assertEquals("Date3r", resourceFieldAliases.getAlias(ResourceField.DATE3));
      assertEquals("Date4r", resourceFieldAliases.getAlias(ResourceField.DATE4));
      assertEquals("Date5r", resourceFieldAliases.getAlias(ResourceField.DATE5));
      assertEquals("Date6r", resourceFieldAliases.getAlias(ResourceField.DATE6));
      assertEquals("Date7r", resourceFieldAliases.getAlias(ResourceField.DATE7));
      assertEquals("Date8r", resourceFieldAliases.getAlias(ResourceField.DATE8));
      assertEquals("Date9r", resourceFieldAliases.getAlias(ResourceField.DATE9));
      assertEquals("Date10r", resourceFieldAliases.getAlias(ResourceField.DATE10));
      assertEquals("Flag1r", resourceFieldAliases.getAlias(ResourceField.FLAG1));
      assertEquals("Flag2r", resourceFieldAliases.getAlias(ResourceField.FLAG2));
      assertEquals("Flag3r", resourceFieldAliases.getAlias(ResourceField.FLAG3));
      assertEquals("Flag4r", resourceFieldAliases.getAlias(ResourceField.FLAG4));
      assertEquals("Flag5r", resourceFieldAliases.getAlias(ResourceField.FLAG5));
      assertEquals("Flag6r", resourceFieldAliases.getAlias(ResourceField.FLAG6));
      assertEquals("Flag7r", resourceFieldAliases.getAlias(ResourceField.FLAG7));
      assertEquals("Flag8r", resourceFieldAliases.getAlias(ResourceField.FLAG8));
      assertEquals("Flag9r", resourceFieldAliases.getAlias(ResourceField.FLAG9));
      assertEquals("Flag10r", resourceFieldAliases.getAlias(ResourceField.FLAG10));
      assertEquals("Flag11r", resourceFieldAliases.getAlias(ResourceField.FLAG11));
      assertEquals("Flag12r", resourceFieldAliases.getAlias(ResourceField.FLAG12));
      assertEquals("Flag13r", resourceFieldAliases.getAlias(ResourceField.FLAG13));
      assertEquals("Flag14r", resourceFieldAliases.getAlias(ResourceField.FLAG14));
      assertEquals("Flag15r", resourceFieldAliases.getAlias(ResourceField.FLAG15));
      assertEquals("Flag16r", resourceFieldAliases.getAlias(ResourceField.FLAG16));
      assertEquals("Flag17r", resourceFieldAliases.getAlias(ResourceField.FLAG17));
      assertEquals("Flag18r", resourceFieldAliases.getAlias(ResourceField.FLAG18));
      assertEquals("Flag19r", resourceFieldAliases.getAlias(ResourceField.FLAG19));
      assertEquals("Flag20r", resourceFieldAliases.getAlias(ResourceField.FLAG20));
      assertEquals("Number1r", resourceFieldAliases.getAlias(ResourceField.NUMBER1));
      assertEquals("Number2r", resourceFieldAliases.getAlias(ResourceField.NUMBER2));
      assertEquals("Number3r", resourceFieldAliases.getAlias(ResourceField.NUMBER3));
      assertEquals("Number4r", resourceFieldAliases.getAlias(ResourceField.NUMBER4));
      assertEquals("Number5r", resourceFieldAliases.getAlias(ResourceField.NUMBER5));
      assertEquals("Number6r", resourceFieldAliases.getAlias(ResourceField.NUMBER6));
      assertEquals("Number7r", resourceFieldAliases.getAlias(ResourceField.NUMBER7));
      assertEquals("Number8r", resourceFieldAliases.getAlias(ResourceField.NUMBER8));
      assertEquals("Number9r", resourceFieldAliases.getAlias(ResourceField.NUMBER9));
      assertEquals("Number10r", resourceFieldAliases.getAlias(ResourceField.NUMBER10));
      assertEquals("Number11r", resourceFieldAliases.getAlias(ResourceField.NUMBER11));
      assertEquals("Number12r", resourceFieldAliases.getAlias(ResourceField.NUMBER12));
      assertEquals("Number13r", resourceFieldAliases.getAlias(ResourceField.NUMBER13));
      assertEquals("Number14r", resourceFieldAliases.getAlias(ResourceField.NUMBER14));
      assertEquals("Number15r", resourceFieldAliases.getAlias(ResourceField.NUMBER15));
      assertEquals("Number16r", resourceFieldAliases.getAlias(ResourceField.NUMBER16));
      assertEquals("Number17r", resourceFieldAliases.getAlias(ResourceField.NUMBER17));
      assertEquals("Number18r", resourceFieldAliases.getAlias(ResourceField.NUMBER18));
      assertEquals("Number19r", resourceFieldAliases.getAlias(ResourceField.NUMBER19));
      assertEquals("Number20r", resourceFieldAliases.getAlias(ResourceField.NUMBER20));
      assertEquals("Duration1r", resourceFieldAliases.getAlias(ResourceField.DURATION1));
      assertEquals("Duration2r", resourceFieldAliases.getAlias(ResourceField.DURATION2));
      assertEquals("Duration3r", resourceFieldAliases.getAlias(ResourceField.DURATION3));
      assertEquals("Duration4r", resourceFieldAliases.getAlias(ResourceField.DURATION4));
      assertEquals("Duration5r", resourceFieldAliases.getAlias(ResourceField.DURATION5));
      assertEquals("Duration6r", resourceFieldAliases.getAlias(ResourceField.DURATION6));
      assertEquals("Duration7r", resourceFieldAliases.getAlias(ResourceField.DURATION7));
      assertEquals("Duration8r", resourceFieldAliases.getAlias(ResourceField.DURATION8));
      assertEquals("Duration9r", resourceFieldAliases.getAlias(ResourceField.DURATION9));
      assertEquals("Duration10r", resourceFieldAliases.getAlias(ResourceField.DURATION10));
      assertEquals("Outline Code1r", resourceFieldAliases.getAlias(ResourceField.OUTLINE_CODE1));
      assertEquals("Outline Code2r", resourceFieldAliases.getAlias(ResourceField.OUTLINE_CODE2));
      assertEquals("Outline Code3r", resourceFieldAliases.getAlias(ResourceField.OUTLINE_CODE3));
      assertEquals("Outline Code4r", resourceFieldAliases.getAlias(ResourceField.OUTLINE_CODE4));
      assertEquals("Outline Code5r", resourceFieldAliases.getAlias(ResourceField.OUTLINE_CODE5));
      assertEquals("Outline Code6r", resourceFieldAliases.getAlias(ResourceField.OUTLINE_CODE6));
      assertEquals("Outline Code7r", resourceFieldAliases.getAlias(ResourceField.OUTLINE_CODE7));
      assertEquals("Outline Code8r", resourceFieldAliases.getAlias(ResourceField.OUTLINE_CODE8));
      assertEquals("Outline Code9r", resourceFieldAliases.getAlias(ResourceField.OUTLINE_CODE9));
      assertEquals("Outline Code10r", resourceFieldAliases.getAlias(ResourceField.OUTLINE_CODE10));
   }
