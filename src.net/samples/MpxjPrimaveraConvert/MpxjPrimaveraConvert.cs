...
namespace MpxjSample
{
    ...
    class MpxjPrimaveraConvert
    {
        static void Main(string[] args)
        {
          try
          {
             ...
             else
             {
                ...
                convert.Process(args[0], args[1], FileFormat.valueOf(args[2]), args[3]);
             }
          }
        ...
        public void Process (string connectionString, string projectID, FileFormat outputFormat, string outputFile)
        {
            //
